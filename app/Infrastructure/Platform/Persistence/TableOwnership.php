...
final class TableOwnership
{
    ...
    public const TABLES = [
        ...
        'Growth' => [
            ...
            'tn_growth_signal_collector_runs', 'tn_growth_signal_source_receipts', 'tn_growth_signal_feeds', 'tn_growth_json_signal_sources',
            ...
            'tn_growth_conversation_routes', 'tn_growth_engagement_suppressions',
            'tn_growth_market_universes', 'tn_growth_market_discovery_runs', 'tn_growth_market_memberships',
