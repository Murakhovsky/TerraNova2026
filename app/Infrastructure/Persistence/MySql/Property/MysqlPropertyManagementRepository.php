...
final class MysqlPropertyManagementRepository implements PropertyManagementRepositoryInterface
{
    ...
    {
        return $this->workflow->stageRules();
    }
    ...
    public function quickAction(int $propertyId, string $action, array $input = [], ?int $userId = null): array
    {
        ...
        try {
            ...
            $nextStage = $this->workflow->nextStage($currentStage);
    ...
    {
        return $this->workflow->isPublicStatus($status);
    }

    private function propertyVisibilityOptions(): array
    {
        return $this->workflow->visibilityOptions();
    }

    private function salePriorities(): array
    {
        return $this->workflow->salePriorities();
    }

    private function commissionTypes(): array
    {
        return $this->workflow->commissionTypes();
    }
