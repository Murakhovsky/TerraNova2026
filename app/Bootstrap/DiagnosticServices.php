...
$di->setShared('diagnosticSessionRepository', fn (): MysqlDiagnosticSessionRepository => new MysqlDiagnosticSessionRepository(
    $this->getShared('databaseService')->connection(),
));
...
$di->setShared('diagnosticDraftPack', fn (): DraftDiagnosticPack => new DraftDiagnosticPack(
    $this->getShared('diagnosticPackRepository'), $this->getShared('eventBus'), $this->getShared('cosTransactionManager'),
));
$di->setShared('diagnosticRevisePack', fn (): ReviseDiagnosticPack => new ReviseDiagnosticPack(
    $this->getShared('diagnosticPackRepository'), $this->getShared('eventBus'), $this->getShared('cosTransactionManager'),
));
$di->setShared('diagnosticStartSession', fn (): StartDiagnosticSession => new StartDiagnosticSession(
    $this->getShared('diagnosticPackRepository'),
    $this->getShared('diagnosticSessionRepository'),
    $this->getShared('eventBus'),
    $this->getShared('cosTransactionManager'),
));
$di->setShared('diagnosticCaptureEvidence', fn (): CaptureDiagnosticEvidence => new CaptureDiagnosticEvidence(
    $this->getShared('diagnosticSessionRepository'),
    $this->getShared('eventBus'),
    $this->getShared('cosTransactionManager'),
));
$di->setShared('diagnosticRecordResult', fn (): RecordDiagnosticResult => new RecordDiagnosticResult(
    $this->getShared('diagnosticPackRepository'),
    $this->getShared('diagnosticSessionRepository'),
    $this->getShared('eventBus'),
    $this->getShared('cosTransactionManager'),
...
$di->setShared('diagnosticCompleteSession', fn (): CompleteDiagnosticSession => new CompleteDiagnosticSession(
    $this->getShared('diagnosticPackRepository'),
    $this->getShared('diagnosticSessionRepository'),
    $this->getShared('eventBus'),
    $this->getShared('cosTransactionManager'),
));
$di->setShared('diagnosticCancelSession', fn (): CancelDiagnosticSession => new CancelDiagnosticSession(
    $this->getShared('diagnosticSessionRepository'), $this->getShared('eventBus'), $this->getShared('cosTransactionManager'),
));
