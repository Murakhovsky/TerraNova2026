...
final class MethodologyStudioController extends ControllerBase
{
 public function indexAction():void
 {
  ...
  if(!$access->allows($organizationId,(int)$user['id'],DiagnosticMethodologyAccess::VIEW)){$this->response->setStatusCode(403,'Forbidden');return;}
  $this->view->metaTitle='Diagnostic Methodology Studio | COS';$this->view->active='diagnostics';$this->view->csrfToken=$this->di->getShared('csrfTokenManager')->token();
 }
}
