...
class Translator{
    ...
    public static function t(string $text): string{
        ...
        $defaultLocale = 'ua';
        $lang_file = APP_PATH . "/Interfaces/Telegram/Language/{$defaultLocale}.php";
    ...
    public static function pm($command, $page){
        ...
        $defaultLocale = 'ua';
        $page_messages_file = APP_PATH . "/Interfaces/Telegram/Language/{$defaultLocale}_page_message.php";
