...
//            $text = trim($message->getText(true));
            ...
            switch ($command) {
                ...
                case 'inlineKBPhotos':
                {
                    ...
                    $object_id = $param1;
                    if ($type == 'AdvertTG') {
                        $model = RealtyTgAdvert::class;
                    } else {
                        Messages::sendCallbackAnswer($callback_id, "Цей тип зовнішнього оголошення більше не підтримується.");
                        break;
                    }
                ...
                case 'delete':{
                    ...
                    switch ($keyboard_data[2]) {
                        ...
                        case "object":
                        {
                            ...
                            $model_type = RealtyTgAdvert::class;
                            break;
                        }
                        case 'request':{
