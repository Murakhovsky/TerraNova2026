...
//        $data = $this->getUpdate()->getCallbackQuery()->getData();
        ...
        elseif (!empty($callback)) {
            // access rules
            /** @var TelegramAccessPolicyInterface $accessPolicy */
            $accessPolicy = di('telegramAccessPolicy');
            $status = $accessPolicy->getStatus($user_id);
            $access = $accessPolicy->check($user_id, 'menu_'.$page);
