...
namespace Domains\Identity\Infrastructure\Persistence\Phalcon\Telegram\Company;

use Domains\Identity\Infrastructure\Persistence\Phalcon\Telegram\BaseModel;
...
//        Messages::sendMeMessage(count($employees_new));
    ...
    static function getEmployeesJoinUsers($company_id)
    {
        ...
        $user_model = AppUsers::class;
        $employees_model = self::class;
