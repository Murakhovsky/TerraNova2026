...
namespace Domains\Identity\Infrastructure\Persistence\Phalcon\Telegram;
...
//
    ...
    public function saveModel(): ?int
    {
        ...
        if (!$this->save()) {
            ...
            throw new DatabaseOperationFailed('Не вдалося зберегти дані в базу (' . $this->usage . ')' . PHP_EOL . $mess);
        }
