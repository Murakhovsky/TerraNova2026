...
final readonly class ScheduleFollowupHandler implements ActionHandlerInterface
{
    ...
    public function __construct(private ScheduleDealFollowup $followups)
    {
    }
    ...
    public function execute(Action $action): ExecutionResult
    {
        ...
        return $result->successful
            ? ExecutionResult::success(['followup_id' => $result->externalId, 'due_at' => $dueAt->format(DATE_ATOM), ...$result->data], ['followups_scheduled' => ($result->data['duplicate'] ?? false) ? 0 : 1])
