...
final readonly class SalesDealOwnerHistoryRebuilder
{
    public function __construct(
        private SalesHistoricalEventStreamInterface $events,
        private SalesDealOwnerHistoryProjector $projector,
        private SalesDealOwnerHistoryStoreInterface $history,
    ...
    public function rebuildOrganization(string $organizationId): array
    {
        ...
        if ($organizationId === '') {
            throw new InvalidArgumentException('Organization id is required for Sales owner history rebuild.');
        }
