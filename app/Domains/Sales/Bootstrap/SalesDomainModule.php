...
final readonly class SalesDomainModule implements DomainModuleInterface
{
    ...
    {
        return [
            CallCompleted::TYPE, ClientCaseChanged::TYPE, ClientCaseCreated::TYPE, DealCreated::TYPE,
            DealStageChanged::TYPE, FollowupOverdue::TYPE, LeadChanged::TYPE, LeadCreated::TYPE,
        ];
    }

    public function actionTypes(): array
    {
        return [...CreateFollowupTaskHandler::TYPES, UpdateDealHandler::TYPE, ...SendMessageHandler::TYPES, ScheduleFollowupHandler::TYPE];
    }
