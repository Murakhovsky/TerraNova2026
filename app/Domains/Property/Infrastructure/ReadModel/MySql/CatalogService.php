...
class CatalogService implements PropertyCatalogInterface
{
    public function __construct(private PdoConnection $database, private ?PropertyAnalyticsInterface $analytics = null)
    {
    }
    ...
    public function recordPropertyView(int $propertyId, array $context = []): void
    {
        ...
        try {
            ...
            $this->analytics?->recordView($propertyId, $context);
        } catch (\Throwable) {
    ...
    public function locations(): array
    {
        return array_map(
            static fn(array $location): array => [
                ...
                'region' => $location['region'] !== null ? (string) $location['region'] : null,
            ],
            $this->database->fetchAll('
