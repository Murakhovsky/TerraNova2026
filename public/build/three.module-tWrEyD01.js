...
var Pt = {
	...
	*[Symbol.iterator]() {
...
}, It = /*@__PURE__*/ new G(), Lt = /*@__PURE__*/ new Ft(), K = class e {
	static {
	...
	scale(e, t) {
		return ot("Matrix3: .scale() is deprecated. Use .makeScale() instead."), this.premultiply(Rt.makeScale(e, t)), this;
	}
	rotate(e) {
		return ot("Matrix3: .rotate() is deprecated. Use .makeRotation() instead."), this.premultiply(Rt.makeRotation(-e)), this;
	}
	translate(e, t) {
		return ot("Matrix3: .translate() is deprecated. Use .makeTranslation() instead."), this.premultiply(Rt.makeTranslation(e, t)), this;
	}
	makeTranslation(e, t) {
...
}, Rt = /*@__PURE__*/ new K(), zt = /*@__PURE__*/ new K().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322), Bt = /*@__PURE__*/ new K().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function Vt() {
	let e = {
		enabled: !0,
		...
		getTransfer: function(e) {
			return e === "" ? Ke : this.spaces[e].transfer;
		},
...
var Wt, Gt = class {
	static getDataURL(e, t = "image/png") {
		...
		if (e instanceof HTMLCanvasElement) n = e;
			...
			Wt === void 0 && (Wt = tt("canvas")), Wt.width = e.width, Wt.height = e.height;
	...
	transformUv(e) {
		...
		if (e.applyMatrix3(this.matrix), e.x < 0 || e.x > 1) switch (this.wrapS) {
			...
			case i:
				e.x = e.x < 0 ? 0 : 1;
				break;
			case a: Math.abs(Math.floor(e.x) % 2) === 1 ? e.x = Math.ceil(e.x) - e.x : e.x -= Math.floor(e.x);
		}
		if (e.y < 0 || e.y > 1) switch (this.wrapT) {
			...
			case i:
				e.y = e.y < 0 ? 0 : 1;
				break;
			case a: Math.abs(Math.floor(e.y) % 2) === 1 ? e.y = Math.ceil(e.y) - e.y : e.y -= Math.floor(e.y);
		}
...
var J = class e {
	...
	*[Symbol.iterator]() {
	...
	constructor(e = 1, t = 1, n = 1, r = {}) {
		super(e, t, r), this.isWebGLArrayRenderTarget = !0, this.depth = n, this.texture = new en(null, e, t, n), this._setTextureOptions(r), this.texture.isRenderTargetTexture = !0;
	}
}, nn = class extends Zt {
	constructor(e = null, t = 1, n = 1, r = 1) {
	...
	makePerspective(e, t, n, r, i, a, o = Qe, s = !1) {
	...
	makeOrthographic(e, t, n, r, i, a, o = Qe, s = !1) {
...
}, rn = /*@__PURE__*/ new G(), an = /*@__PURE__*/ new Y(), on = /*@__PURE__*/ new G(0, 0, 0), sn = /*@__PURE__*/ new G(1, 1, 1), cn = /*@__PURE__*/ new G(), ln = /*@__PURE__*/ new G(), un = /*@__PURE__*/ new G(), dn = /*@__PURE__*/ new Y(), fn = /*@__PURE__*/ new Ft(), pn = class e {
...
var mn = class {
...
}, hn = 0, gn = /*@__PURE__*/ new G(), _n = /*@__PURE__*/ new Ft(), vn = /*@__PURE__*/ new Y(), yn = /*@__PURE__*/ new G(), bn = /*@__PURE__*/ new G(), xn = /*@__PURE__*/ new G(), Sn = /*@__PURE__*/ new Ft(), Cn = /*@__PURE__*/ new G(1, 0, 0), wn = /*@__PURE__*/ new G(0, 1, 0), Tn = /*@__PURE__*/ new G(0, 0, 1), En = { type: "added" }, Dn = { type: "removed" }, On = {
	type: "childadded",
	child: null
}, kn = {
	type: "childremoved",
	...
	constructor() {
		...
		let t = new G(), n = new pn(), r = new Ft(), i = new G(1, 1, 1);
		function a() {
			r.setFromEuler(n, !1);
		}
		function o() {
	...
	add(e) {
		...
		return e === this ? (V("Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(En), On.child = e, this.dispatchEvent(On), On.child = null) : V("Object3D.add: object not an instance of THREE.Object3D.", e), this);
	}
	remove(e) {
		if (arguments.length > 1) {
...
An.DEFAULT_UP = /*@__PURE__*/ new G(0, 1, 0), An.DEFAULT_MATRIX_AUTO_UPDATE = !0, An.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0;
var jn = class extends An {
	...
	getTargetRaySpace() {
		return this._targetRay === null && (this._targetRay = new jn(), this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1, this._targetRay.hasLinearVelocity = !1, this._targetRay.linearVelocity = new G(), this._targetRay.hasAngularVelocity = !1, this._targetRay.angularVelocity = new G()), this._targetRay;
	}
	getGripSpace() {
		return this._grip === null && (this._grip = new jn(), this._grip.matrixAutoUpdate = !1, this._grip.visible = !1, this._grip.hasLinearVelocity = !1, this._grip.linearVelocity = new G(), this._grip.hasAngularVelocity = !1, this._grip.angularVelocity = new G(), this._grip.eventsEnabled = !1), this._grip;
	}
	dispatchEvent(e) {
...
var X = class {
	...
	setHSL(e, t, n, r = q.workingColorSpace) {
		if (e = ht(e, 1), t = H(t, 0, 1), n = H(n, 0, 1), t === 0) this.r = this.g = this.b = n;
		else {
	...
	getHex(e = We) {
		return q.workingToColorSpace(Rn.copy(this), e), Math.round(H(Rn.r * 255, 0, 255)) * 65536 + Math.round(H(Rn.g * 255, 0, 255)) * 256 + Math.round(H(Rn.b * 255, 0, 255));
	}
	getHexString(e = We) {
		return ("000000" + this.getHex(e).toString(16)).slice(-6);
	}
	getHSL(e, t = q.workingColorSpace) {
		q.workingToColorSpace(Rn.copy(this), t);
	...
	getRGB(e, t = q.workingColorSpace) {
		return q.workingToColorSpace(Rn.copy(this), t), e.r = Rn.r, e.g = Rn.g, e.b = Rn.b, e;
	}
	getStyle(e = We) {
		q.workingToColorSpace(Rn.copy(this), e);
...
var zn = class extends An {
...
}, Bn = /*@__PURE__*/ new G(), Vn = /*@__PURE__*/ new G(), Hn = /*@__PURE__*/ new G(), Un = /*@__PURE__*/ new G(), Wn = /*@__PURE__*/ new G(), Gn = /*@__PURE__*/ new G(), Kn = /*@__PURE__*/ new G(), qn = /*@__PURE__*/ new G(), Jn = /*@__PURE__*/ new G(), Yn = /*@__PURE__*/ new G(), Xn = /*@__PURE__*/ new J(), Zn = /*@__PURE__*/ new J(), Qn = /*@__PURE__*/ new J(), $n = class e {
	...
	static containsPoint(e, t, n, r) {
		return this.getBarycoord(e, t, n, r, Un) !== null && Un.x >= 0 && Un.y >= 0 && Un.x + Un.y <= 1;
	}
	...
	/*@__PURE__*/ new G(),
	/*@__PURE__*/ new G()
], nr = /*@__PURE__*/ new G(), rr = /*@__PURE__*/ new er(), ir = /*@__PURE__*/ new G(), ar = /*@__PURE__*/ new G(), or = /*@__PURE__*/ new G(), sr = /*@__PURE__*/ new G(), cr = /*@__PURE__*/ new G(), lr = /*@__PURE__*/ new G(), ur = /*@__PURE__*/ new G(), dr = /*@__PURE__*/ new G(), fr = /*@__PURE__*/ new G(), pr = /*@__PURE__*/ new G();
...
var hr = /*@__PURE__*/ new G(), gr = /*@__PURE__*/ new W(), _r = 0, vr = class extends lt {
	constructor(e, t, n = !1) {
		if (super(), Array.isArray(e)) throw TypeError("THREE.BufferAttribute: array should be a Typed Array.");
		this.isBufferAttribute = !0, Object.defineProperty(this, "id", { value: _r++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e === void 0 ? 0 : e.length / t, this.normalized = n, this.usage = Ye, this.updateRanges = [], this.gpuType = y, this.version = 0;
	}
	onUploadCallback() {}
	set needsUpdate(e) {
		e === !0 && this.version++;
...
}, Sr = /*@__PURE__*/ new er(), Cr = /*@__PURE__*/ new G(), wr = /*@__PURE__*/ new G(), Tr = class {
	...
	expandByPoint(e) {
		...
		if (t > this.radius * this.radius) {
			...
			this.center.addScaledVector(Cr, n / e), this.radius += n;
		}
		return this;
	}
	union(e) {
		return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === !0 ? this.radius = Math.max(this.radius, e.radius) : (wr.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(Cr.copy(e.center).add(wr)), this.expandByPoint(Cr.copy(e.center).sub(wr))), this);
	}
	equals(e) {
...
}, Er = 0, Dr = /*@__PURE__*/ new Y(), Or = /*@__PURE__*/ new An(), kr = /*@__PURE__*/ new G(), Ar = /*@__PURE__*/ new er(), jr = /*@__PURE__*/ new er(), Mr = /*@__PURE__*/ new G(), Nr = class e extends lt {
	constructor() {
		super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: Er++ }), this.uuid = mt(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.indirectOffset = 0, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
			start: 0,
			count: Infinity
	...
	setIndex(e) {
		return this.index = Array.isArray(e) ? new ($e(e) ? br : yr)(e, 1) : e, this;
	}
	setIndirect(e, t = 0) {
	...
	setFromPoints(e) {
		...
		if (t === void 0) {
			...
			this.setAttribute("position", new xr(t, 3));
		} else {
	...
	computeBoundingBox() {
		...
		if (e !== void 0) {
			if (this.boundingBox.setFromBufferAttribute(e), t) for (let e = 0, n = t.length; e < n; e++) {
				let n = t[e];
				Ar.setFromBufferAttribute(n), this.morphTargetsRelative ? (Mr.addVectors(this.boundingBox.min, Ar.min), this.boundingBox.expandByPoint(Mr), Mr.addVectors(this.boundingBox.max, Ar.max), this.boundingBox.expandByPoint(Mr)) : (this.boundingBox.expandByPoint(Ar.min), this.boundingBox.expandByPoint(Ar.max));
			}
	...
	computeBoundingSphere() {
		...
		if (e) {
			...
			if (Ar.setFromBufferAttribute(e), t) for (let e = 0, n = t.length; e < n; e++) {
				let n = t[e];
				jr.setFromBufferAttribute(n), this.morphTargetsRelative ? (Mr.addVectors(Ar.min, jr.min), Ar.expandByPoint(Mr), Mr.addVectors(Ar.max, jr.max), Ar.expandByPoint(Mr)) : (Ar.expandByPoint(jr.min), Ar.expandByPoint(jr.max));
			}
			Ar.getCenter(n);
			let r = 0;
			for (let t = 0, i = e.count; t < i; t++) Mr.fromBufferAttribute(e, t), r = Math.max(r, n.distanceToSquared(Mr));
			if (t) for (let i = 0, a = t.length; i < a; i++) {
				let a = t[i], o = this.morphTargetsRelative;
				for (let t = 0, i = a.count; t < i; t++) Mr.fromBufferAttribute(a, t), o && (kr.fromBufferAttribute(e, t), Mr.add(kr)), r = Math.max(r, n.distanceToSquared(Mr));
			}
	...
	computeTangents() {
		...
		(a === void 0 || a.count !== n.count) && (a = new vr(new Float32Array(4 * n.count), 4), this.setAttribute("tangent", a));
		let o = [], s = [];
	...
	computeVertexNormals() {
		...
		if (t !== void 0) {
			...
			if (n === void 0 || n.count !== t.count) n = new vr(new Float32Array(t.count * 3), 3), this.setAttribute("normal", n);
	...
	normalizeNormals() {
		...
		for (let t = 0, n = e.count; t < n; t++) Mr.fromBufferAttribute(e, t), Mr.normalize(), e.setXYZ(t, Mr.x, Mr.y, Mr.z);
	}
	toNonIndexed() {
		function t(e, t) {
	...
	constructor(e, t) {
		this.isInterleavedBuffer = !0, this.array = e, this.stride = t, this.count = e === void 0 ? 0 : e.length / t, this.usage = Ye, this.updateRanges = [], this.version = 0, this.uuid = mt();
	}
	onUploadCallback() {}
	set needsUpdate(e) {
		e === !0 && this.version++;
	...
	applyMatrix4(e) {
		for (let t = 0, n = this.data.count; t < n; t++) Fr.fromBufferAttribute(this, t), Fr.applyMatrix4(e), this.setXYZ(t, Fr.x, Fr.y, Fr.z);
		return this;
	}
	applyNormalMatrix(e) {
...
}, Lr = 0, Rr = class extends lt {
	constructor() {
		super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: Lr++ }), this.uuid = mt(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new X(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = Je, this.stencilZFail = Je, this.stencilZPass = Je, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
	}
	get alphaTest() {
...
}, zr = /*@__PURE__*/ new G(), Br = /*@__PURE__*/ new G(), Vr = /*@__PURE__*/ new G(), Hr = /*@__PURE__*/ new G(), Ur = /*@__PURE__*/ new G(), Wr = /*@__PURE__*/ new G(), Gr = /*@__PURE__*/ new G(), Kr = class {
	...
	distanceSqToSegment(e, t, n, r) {
		Br.copy(e).add(t).multiplyScalar(.5), Vr.copy(t).sub(e).normalize(), Hr.copy(this.origin).sub(Br);
		let i = e.distanceTo(t) * .5, a = -this.direction.dot(Vr), o = Hr.dot(this.direction), s = -Hr.dot(Vr), c = Hr.lengthSq(), l = Math.abs(1 - a * a), u, d, f, p;
		if (l > 0) {
		...
		return n && n.copy(this.origin).addScaledVector(this.direction, u), r && r.copy(Br).addScaledVector(Vr, d), f;
	}
	intersectSphere(e, t) {
	...
	intersectTriangle(e, t, n, r, i) {
		Ur.subVectors(t, e), Wr.subVectors(n, e), Gr.crossVectors(Ur, Wr);
		...
		let s = o * this.direction.dot(Wr.crossVectors(Hr, Wr));
		if (s < 0) return null;
		let c = o * this.direction.dot(Ur.cross(Hr));
...
}, Jr = /*@__PURE__*/ new Y(), Yr = /*@__PURE__*/ new Kr(), Xr = /*@__PURE__*/ new Tr(), Zr = /*@__PURE__*/ new G(), Qr = /*@__PURE__*/ new G(), $r = /*@__PURE__*/ new G(), ei = /*@__PURE__*/ new G(), ti = /*@__PURE__*/ new G(), ni = /*@__PURE__*/ new G(), ri = /*@__PURE__*/ new G(), ii = /*@__PURE__*/ new G(), ai = class extends An {
	constructor(e = new Nr(), t = new qr()) {
	...
	getVertexPosition(e, t) {
		...
		if (i && o) {
			...
			for (let n = 0, r = i.length; n < r; n++) {
				let r = o[n], s = i[n];
				r !== 0 && (ti.fromBufferAttribute(s, e), a ? ni.addScaledVector(ti, r) : ni.addScaledVector(ti.sub(t), r));
			}
			t.add(ni);
		}
		return t;
	...
	raycast(e, t) {
		...
		r !== void 0 && (n.boundingSphere === null && n.computeBoundingSphere(), Xr.copy(n.boundingSphere), Xr.applyMatrix4(i), Yr.copy(e.ray).recast(e.near), !(Xr.containsPoint(Yr.origin) === !1 && (Yr.intersectSphere(Xr, Zr) === null || Yr.origin.distanceToSquared(Zr) > (e.far - e.near) ** 2)) && (Jr.copy(i).invert(), Yr.copy(e.ray).applyMatrix4(Jr), (n.boundingBox === null || Yr.intersectsBox(n.boundingBox) !== !1) && this._computeIntersections(e, t, Yr)));
	}
...
function oi(e, t, n, r, i, a, o, s) {
	...
	ii.copy(s), ii.applyMatrix4(e.matrixWorld);
	let l = n.ray.origin.distanceTo(ii);
...
function si(e, t, n, r, i, a, o, s, c, l) {
	e.getVertexPosition(s, Qr), e.getVertexPosition(c, $r), e.getVertexPosition(l, ei);
	let u = oi(e, t, n, r, Qr, $r, ei, ri);
	if (u) {
		let e = new G();
		$n.getBarycoord(ri, Qr, $r, ei, e), i && (u.uv = $n.getInterpolatedAttribute(i, s, c, l, e, new W())), a && (u.uv1 = $n.getInterpolatedAttribute(a, s, c, l, e, new W())), o && (u.normal = $n.getInterpolatedAttribute(o, s, c, l, e, new G()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
		let t = {
			a: s,
			b: c,
			c: l,
		...
		$n.getNormal(Qr, $r, ei, t.normal), u.face = t, u.barycoord = e;
	}
	return u;
}
var ci = /*@__PURE__*/ new J(), li = /*@__PURE__*/ new J(), ui = /*@__PURE__*/ new J(), di = /*@__PURE__*/ new J(), fi = /*@__PURE__*/ new Y(), pi = /*@__PURE__*/ new G(), mi = /*@__PURE__*/ new Tr(), hi = /*@__PURE__*/ new Y(), gi = /*@__PURE__*/ new Kr(), _i = class extends ai {
	constructor(e, t) {
		super(e, t), this.isSkinnedMesh = !0, this.type = "SkinnedMesh", this.bindMode = n, this.bindMatrix = new Y(), this.bindMatrixInverse = new Y(), this.boundingBox = null, this.boundingSphere = null;
	}
	computeBoundingBox() {
		let e = this.geometry;
		this.boundingBox === null && (this.boundingBox = new er()), this.boundingBox.makeEmpty();
		let t = e.getAttribute("position");
		for (let e = 0; e < t.count; e++) this.getVertexPosition(e, pi), this.boundingBox.expandByPoint(pi);
	}
	computeBoundingSphere() {
		let e = this.geometry;
		this.boundingSphere === null && (this.boundingSphere = new Tr()), this.boundingSphere.makeEmpty();
		let t = e.getAttribute("position");
		for (let e = 0; e < t.count; e++) this.getVertexPosition(e, pi), this.boundingSphere.expandByPoint(pi);
	}
	copy(e, t) {
	...
	raycast(e, t) {
		...
		n !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), mi.copy(this.boundingSphere), mi.applyMatrix4(r), e.ray.intersectsSphere(mi) !== !1 && (hi.copy(r).invert(), gi.copy(e.ray).applyMatrix4(hi), (this.boundingBox === null || gi.intersectsBox(this.boundingBox) !== !1) && this._computeIntersections(e, t, gi)));
	}
	getVertexPosition(e, t) {
	...
	applyBoneTransform(e, t) {
		...
		li.fromBufferAttribute(r.attributes.skinIndex, e), ui.fromBufferAttribute(r.attributes.skinWeight, e), t.isVector4 ? (ci.copy(t), t.set(0, 0, 0, 0)) : (ci.set(...t, 1), t.set(0, 0, 0)), ci.applyMatrix4(this.bindMatrix);
		for (let e = 0; e < 4; e++) {
			let r = ui.getComponent(e);
			if (r !== 0) {
				let i = li.getComponent(e);
				fi.multiplyMatrices(n.bones[i].matrixWorld, n.boneInverses[i]), t.addScaledVector(di.copy(ci).applyMatrix4(fi), r);
			}
		}
		return t.isVector4 && (t.w = ci.w), t.applyMatrix4(this.bindMatrixInverse);
	}
}, vi = class extends An {
	constructor() {
...
}, bi = /*@__PURE__*/ new Y(), xi = /*@__PURE__*/ new Y(), Si = class e {
	constructor(e = [], t = []) {
		this.uuid = mt(), this.bones = e.slice(0), this.boneInverses = t, this.boneMatrices = null, this.boneTexture = null, this.init();
	}
	init() {
	...
	update() {
		...
		for (let r = 0, i = e.length; r < i; r++) {
			let i = e[r] ? e[r].matrixWorld : xi;
			bi.multiplyMatrices(i, t[r]), bi.toArray(n, r * 16);
		}
	...
	fromJSON(e, t) {
		...
		for (let n = 0, r = e.bones.length; n < r; n++) {
			...
			i === void 0 && (B("Skeleton: No bone found with UUID:", r), i = new vi()), this.bones.push(i), this.boneInverses.push(new Y().fromArray(e.boneInverses[n]));
		}
...
}, wi = /*@__PURE__*/ new Y(), Ti = /*@__PURE__*/ new Y(), Ei = [], Di = /*@__PURE__*/ new er(), Oi = /*@__PURE__*/ new Y(), ki = /*@__PURE__*/ new ai(), Ai = /*@__PURE__*/ new Tr(), ji = class extends ai {
	constructor(e, t, n) {
		super(e, t), this.isInstancedMesh = !0, this.instanceMatrix = new Ci(new Float32Array(n * 16), 16), this.instanceColor = null, this.morphTexture = null, this.count = n, this.boundingBox = null, this.boundingSphere = null;
	...
	computeBoundingBox() {
		...
		for (let n = 0; n < t; n++) this.getMatrixAt(n, wi), Di.copy(e.boundingBox).applyMatrix4(wi), this.boundingBox.union(Di);
	}
	computeBoundingSphere() {
		let e = this.geometry, t = this.count;
		this.boundingSphere === null && (this.boundingSphere = new Tr()), e.boundingSphere === null && e.computeBoundingSphere(), this.boundingSphere.makeEmpty();
		for (let n = 0; n < t; n++) this.getMatrixAt(n, wi), Ai.copy(e.boundingSphere).applyMatrix4(wi), this.boundingSphere.union(Ai);
	}
	copy(e, t) {
	...
	raycast(e, t) {
		...
		if (ki.geometry = this.geometry, ki.material = this.material, ki.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), Ai.copy(this.boundingSphere), Ai.applyMatrix4(n), e.ray.intersectsSphere(Ai) !== !1)) for (let i = 0; i < r; i++) {
			this.getMatrixAt(i, wi), Ti.multiplyMatrices(n, wi), ki.matrixWorld = Ti, ki.raycast(e, Ei);
	...
	setColorAt(e, t) {
		return this.instanceColor === null && (this.instanceColor = new Ci(new Float32Array(this.instanceMatrix.count * 3).fill(1), 3)), t.toArray(this.instanceColor.array, e * 3), this;
	}
	setMatrixAt(e, t) {
	...
	setMorphAt(e, t) {
		...
		this.morphTexture === null && (this.morphTexture = new yi(new Float32Array(r * this.count), r, this.count, j, y));
...
}, Mi = /*@__PURE__*/ new G(), Ni = /*@__PURE__*/ new G(), Pi = /*@__PURE__*/ new K(), Fi = class {
	...
	setFromCoplanarPoints(e, t, n) {
		let r = Mi.subVectors(n, t).cross(Ni.subVectors(e, t)).normalize();
	...
	intersectLine(e, t, n = !0) {
		let r = e.delta(Mi), i = this.normal.dot(r);
	...
	applyMatrix4(e, t) {
		let n = t || Pi.getNormalMatrix(e), r = this.coplanarPoint(Mi).applyMatrix4(e), i = this.normal.applyMatrix3(n).normalize();
...
}, Ii = /*@__PURE__*/ new Tr(), Li = /*@__PURE__*/ new W(.5, .5), Ri = /*@__PURE__*/ new G(), zi = class {
	constructor(e = new Fi(), t = new Fi(), n = new Fi(), r = new Fi(), i = new Fi(), a = new Fi()) {
		this.planes = [
			e,
			t,
			n,
	...
	setFromProjectionMatrix(e, t = Qe, n = !1) {
	...
	intersectsSprite(e) {
		return Ii.center.set(0, 0, 0), Ii.radius = .7071067811865476 + Li.distanceTo(e.center), Ii.applyMatrix4(e.matrixWorld), this.intersectsSphere(Ii);
	}
	intersectsSphere(e) {
...
}, Vi = /*@__PURE__*/ new G(), Hi = /*@__PURE__*/ new G(), Ui = /*@__PURE__*/ new Y(), Wi = /*@__PURE__*/ new Kr(), Gi = /*@__PURE__*/ new Tr(), Ki = /*@__PURE__*/ new G(), qi = /*@__PURE__*/ new G(), Ji = class extends An {
	constructor(e = new Nr(), t = new Bi()) {
	...
	computeLineDistances() {
		...
		if (e.index === null) {
			...
			for (let e = 1, r = t.count; e < r; e++) Vi.fromBufferAttribute(t, e - 1), Hi.fromBufferAttribute(t, e), n[e] = n[e - 1], n[e] += Vi.distanceTo(Hi);
			e.setAttribute("lineDistance", new xr(n, 1));
	...
	raycast(e, t) {
		...
		if (n.boundingSphere === null && n.computeBoundingSphere(), Gi.copy(n.boundingSphere), Gi.applyMatrix4(r), Gi.radius += i, e.ray.intersectsSphere(Gi) === !1) return;
		Ui.copy(r).invert(), Wi.copy(e.ray).applyMatrix4(Ui);
		...
		if (l !== null) {
			...
			for (let i = n, a = r - 1; i < a; i += c) {
				let n = l.getX(i), r = l.getX(i + 1), a = Yi(this, e, Wi, s, n, r, i);
				a && t.push(a);
			}
			if (this.isLineLoop) {
				let i = l.getX(r - 1), a = l.getX(n), o = Yi(this, e, Wi, s, i, a, r - 1);
				o && t.push(o);
			}
		} else {
			let n = Math.max(0, a.start), r = Math.min(u.count, a.start + a.count);
			for (let i = n, a = r - 1; i < a; i += c) {
				let n = Yi(this, e, Wi, s, i, i + 1, i);
				n && t.push(n);
			}
			if (this.isLineLoop) {
				let i = Yi(this, e, Wi, s, r - 1, n, r - 1);
				i && t.push(i);
			}
		}
	}
...
function Yi(e, t, n, r, i, a, o) {
	...
	if (Vi.fromBufferAttribute(s, i), Hi.fromBufferAttribute(s, a), n.distanceSqToSegment(Vi, Hi, Ki, qi) > r) return;
	Ki.applyMatrix4(e.matrixWorld);
	let c = t.ray.origin.distanceTo(Ki);
...
var Xi = /*@__PURE__*/ new G(), Zi = /*@__PURE__*/ new G(), Qi = class extends Ji {
	constructor(e, t) {
	...
	computeLineDistances() {
		...
		if (e.index === null) {
			...
			for (let e = 0, r = t.count; e < r; e += 2) Xi.fromBufferAttribute(t, e), Zi.fromBufferAttribute(t, e + 1), n[e] = e === 0 ? 0 : n[e - 1], n[e + 1] = n[e] + Xi.distanceTo(Zi);
			e.setAttribute("lineDistance", new xr(n, 1));
...
}, ta = /*@__PURE__*/ new Y(), na = /*@__PURE__*/ new Kr(), ra = /*@__PURE__*/ new Tr(), ia = /*@__PURE__*/ new G(), aa = class extends An {
	constructor(e = new Nr(), t = new ea()) {
	...
	raycast(e, t) {
		...
		if (n.boundingSphere === null && n.computeBoundingSphere(), ra.copy(n.boundingSphere), ra.applyMatrix4(r), ra.radius += i, e.ray.intersectsSphere(ra) === !1) return;
		ta.copy(r).invert(), na.copy(e.ray).applyMatrix4(ta);
		...
		if (c !== null) {
			...
			for (let a = n, o = i; a < o; a++) {
				let n = c.getX(a);
				ia.fromBufferAttribute(l, n), oa(ia, n, s, r, e, t, this);
			}
		} else {
			let n = Math.max(0, a.start), i = Math.min(l.count, a.start + a.count);
			for (let a = n, o = i; a < o; a++) ia.fromBufferAttribute(l, a), oa(ia, a, s, r, e, t, this);
		}
	}
	updateMorphTargets() {
		let e = this.geometry.morphAttributes, t = Object.keys(e);
...
function oa(e, t, n, r, i, a, o) {
	let s = na.distanceSqToPoint(e);
	if (s < n) {
		let n = new G();
		na.closestPointToPoint(e, n), n.applyMatrix4(r);
...
var sa = class extends Zt {
	...
	constructor(e, t, n, r, a, o) {
		super(e, t, n, a, o), this.isCompressedArrayTexture = !0, this.image.depth = r, this.wrapR = i, this.layerUpdates = /* @__PURE__ */ new Set();
	}
	addLayerUpdate(e) {
		this.layerUpdates.add(e);
	}
	...
	constructor(e, t, n = v, r, i, a, s = o, c = o, l, u = k, d = 1) {
	...
	constructor(e, t = v, n = 301, r, i, a = o, s = o, c, l = k) {
		let u = {
			width: e,
			height: e,
			depth: 1
	...
	constructor(e = 1, t = 1, n = 1, r = 1, i = 1, a = 1) {
		...
		let s = [], c = [], l = [], u = [], d = 0, f = 0;
		p("z", "y", "x", -1, -1, n, t, e, a, i, 0), p("z", "y", "x", 1, -1, n, t, -e, a, i, 1), p("x", "z", "y", 1, 1, e, n, t, r, a, 2), p("x", "z", "y", 1, -1, e, n, -t, r, a, 3), p("x", "y", "z", 1, -1, e, t, n, r, i, 4), p("x", "y", "z", -1, -1, e, t, -n, r, i, 5), this.setIndex(s), this.setAttribute("position", new xr(c, 3)), this.setAttribute("normal", new xr(l, 3)), this.setAttribute("uv", new xr(u, 2));
	...
	constructor(e = 1, t = 1, n = 1, r = 1) {
		...
		this.setIndex(f), this.setAttribute("position", new xr(p, 3)), this.setAttribute("normal", new xr(m, 3)), this.setAttribute("uv", new xr(h, 2));
	}
	copy(e) {
		return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
	}
...
function _a(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (ya(i)) i.isRenderTargetTexture ? (B("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
...
var Sa = {
	...
	constructor(e) {
		super(), this.isMeshDepthMaterial = !0, this.type = "MeshDepthMaterial", this.depthPacking = Ue, this.map = null, this.alphaMap = null, this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.wireframe = !1, this.wireframeLinewidth = 1, this.setValues(e);
	}
	copy(e) {
...
var Fa = class {
	...
	constructor(e, t, n, r) {
		...
		this.name = e, this.times = ja(t, this.TimeBufferType), this.values = ja(n, this.ValueBufferType), this.setInterpolation(r || this.DefaultInterpolation);
	}
	static toJSON(e) {
		...
		if (t.toJSON !== this.toJSON) n = t.toJSON(e);
			...
			n = {
				name: e.name,
				times: ja(e.times, Array),
				values: ja(e.values, Array)
			};
	...
	InterpolantFactoryMethodBezier(e) {
		let t = new za(this.times, this.values, this.getValueSize(), e);
	...
	setInterpolation(e) {
		...
		switch (e) {
			...
			case z:
				...
				break;
			case Le: t = this.InterpolantFactoryMethodBezier;
		}
		if (t === void 0) {
	...
	getInterpolation() {
		switch (this.createInterpolant) {
			...
			case this.InterpolantFactoryMethodSmooth: return z;
			case this.InterpolantFactoryMethodBezier: return Le;
		}
	}
	getValueSize() {
	...
	validate() {
		...
		if (r !== void 0 && et(r)) for (let t = 0, n = r.length; t !== n; ++t) {
			let n = r[t];
			if (isNaN(n)) {
	...
	optimize() {
		let e = this.times.slice(), t = this.values.slice(), n = this.getValueSize(), r = this.getInterpolation() === z, i = e.length - 1, a = 1;
		for (let o = 1; o < i; ++o) {
			let i = !1, s = e[o];
...
Ba.prototype.ValueTypeName = "", Ba.prototype.TimeBufferType = Float32Array, Ba.prototype.ValueBufferType = Float32Array, Ba.prototype.DefaultInterpolation = R;
var Va = class extends Ba {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Va.prototype.ValueTypeName = "bool", Va.prototype.ValueBufferType = Array, Va.prototype.DefaultInterpolation = Ie, Va.prototype.InterpolantFactoryMethodLinear = void 0, Va.prototype.InterpolantFactoryMethodSmooth = void 0;
...
Ga.prototype.ValueTypeName = "quaternion", Ga.prototype.InterpolantFactoryMethodSmooth = void 0;
var Ka = class extends Ba {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Ka.prototype.ValueTypeName = "string", Ka.prototype.ValueBufferType = Array, Ka.prototype.DefaultInterpolation = Ie, Ka.prototype.InterpolantFactoryMethodLinear = void 0, Ka.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var Ja = class {
	...
	static parse(e) {
		...
		for (let e = 0, i = n.length; e !== i; ++e) t.push(Xa(n[e]).scale(r));
	...
	static toJSON(e) {
		...
		for (let e = 0, r = n.length; e !== r; ++e) t.push(Ba.toJSON(n[e]));
		return r;
	}
	static CreateFromMorphTargetSequence(e, t, n, r) {
		...
		for (let e = 0; e < i; e++) {
			...
			let c = Ma(o);
			o = Na(o, 1, c), s = Na(s, 1, c), !r && o[0] === 0 && (o.push(i), s.push(s[0])), a.push(new Ua(".morphTargetInfluences[" + t[e].name + "]", o, s).scale(1 / n));
		}
...
function Ya(e) {
	switch (e.toLowerCase()) {
		...
		case "float":
		case "number":
		case "integer": return Ua;
		case "vector":
		case "vector2":
		case "vector3":
		case "vector4": return qa;
		case "color": return Ha;
		case "quaternion": return Ga;
		case "bool":
		case "boolean": return Va;
		case "string": return Ka;
	}
...
function Xa(e) {
	...
	if (e.times === void 0) {
		let t = [], n = [];
		Pa(e.keys, t, n, "value"), e.times = t, e.values = n;
	}
...
var Za = {
	...
	get: function(e) {
		if (this.enabled !== !1 && !Qa(e)) return this.files[e];
	},
	remove: function(e) {
		delete this.files[e];
	},
...
var no = {}, ro = class extends Error {
	...
	load(e, t, n, r) {
		...
		fetch(a).then((t) => {
			if (t.status === 200 || t.status === 0) {
				...
				let n = no[e], r = t.body.getReader(), i = t.headers.get("X-File-Size") || t.headers.get("Content-Length"), a = i ? parseInt(i) : 0, o = a !== 0, s = 0, c = new ReadableStream({ start(e) {
					t();
					function t() {
			...
			throw new ro(`fetch for "${t.url}" responded with ${t.status}: ${t.statusText}`, t);
		}).then((e) => {
			switch (s) {
...
}, ao = /* @__PURE__ */ new WeakMap(), oo = class extends to {
	constructor(e) {
		super(e);
	}
	load(e, t, n, r) {
		...
		function s() {
			...
			ao.delete(this), i.manager.itemEnd(e);
		}
		function c(t) {
			...
			ao.delete(this), i.manager.itemError(e), i.manager.itemEnd(e);
		}
		function l() {
	...
	load(e, t, n, r) {
		let i = new Zt(), a = new oo(this.manager);
	...
	constructor(e, t, n) {
		super(e, n), this.isHemisphereLight = !0, this.type = "HemisphereLight", this.position.copy(An.DEFAULT_UP), this.updateMatrix(), this.groundColor = new X(t);
	}
	copy(e, t) {
...
}, uo = /*@__PURE__*/ new Y(), fo = /*@__PURE__*/ new G(), po = /*@__PURE__*/ new G(), mo = class {
	constructor(e) {
		this.camera = e, this.intensity = 1, this.bias = 0, this.biasNode = null, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new W(512, 512), this.mapType = p, this.map = null, this.mapPass = null, this.matrix = new Y(), this.autoUpdate = !0, this.needsUpdate = !1, this._frustum = new zi(), this._frameExtents = new W(1, 1), this._viewportCount = 1, this._viewports = [new J(0, 0, 1, 1)];
	}
	getViewportCount() {
	...
	updateMatrices(e) {
		...
		fo.setFromMatrixPosition(e.matrixWorld), t.position.copy(fo), po.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(po), t.updateMatrixWorld(), uo.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(uo, t.coordinateSystem, t.reversedDepth), t.coordinateSystem === 2001 || t.reversedDepth ? n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, 1, 0, 0, 0, 0, 1) : n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, .5, .5, 0, 0, 0, 1), n.multiply(uo);
	}
	getViewport(e) {
...
}, ho = /*@__PURE__*/ new G(), go = /*@__PURE__*/ new Ft(), _o = /*@__PURE__*/ new G(), vo = class extends An {
	constructor() {
		super(), this.isCamera = !0, this.type = "Camera", this.matrixWorldInverse = new Y(), this.projectionMatrix = new Y(), this.projectionMatrixInverse = new Y(), this.coordinateSystem = Qe, this._reversedDepth = !1;
	}
	get reversedDepth() {
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(ho, go, _o), _o.x === 1 && _o.y === 1 && _o.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(ho, go, _o.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t, n = !1) {
		super.updateWorldMatrix(e, t, n), this.matrixWorld.decompose(ho, go, _o), _o.x === 1 && _o.y === 1 && _o.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(ho, go, _o.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, yo = /*@__PURE__*/ new G(), bo = /*@__PURE__*/ new W(), xo = /*@__PURE__*/ new W(), So = class extends vo {
	...
	getViewBounds(e, t, n) {
		yo.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse), t.set(yo.x, yo.y).multiplyScalar(-e / yo.z), yo.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse), n.set(yo.x, yo.y).multiplyScalar(-e / yo.z);
	}
	getViewSize(e, t) {
		return this.getViewBounds(e, bo, xo), t.subVectors(xo, bo);
	}
	...
	constructor() {
		super(new So(50, 1, .5, 500)), this.isSpotLightShadow = !0, this.focus = 1, this.aspect = 1;
	}
	updateMatrices(e) {
	...
	constructor(e, t, n = 0, r = Math.PI / 3, i = 0, a = 2) {
		super(e, t), this.isSpotLight = !0, this.type = "SpotLight", this.position.copy(An.DEFAULT_UP), this.updateMatrix(), this.target = new An(), this.distance = n, this.angle = r, this.penumbra = i, this.decay = a, this.map = null, this.shadow = new Co();
	}
	get power() {
	...
	constructor() {
		super(new So(90, 1, .5, 500)), this.isPointLightShadow = !0;
	}
}, Eo = class extends co {
	constructor(e, t, n = 0, r = 2) {
		super(e, t), this.isPointLight = !0, this.type = "PointLight", this.distance = n, this.decay = r, this.shadow = new To();
	}
	get power() {
	...
	constructor() {
		super(new Do(-5, 5, 5, -5, .5, 500)), this.isDirectionalLightShadow = !0;
	}
}, ko = class extends co {
	constructor(e, t) {
		super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(An.DEFAULT_UP), this.updateMatrix(), this.target = new An(), this.shadow = new Oo();
	}
	dispose() {
		super.dispose(), this.shadow.dispose();
	}
...
}, Mo = /* @__PURE__ */ new WeakMap(), No = class extends to {
	constructor(e) {
	...
	load(e, t, n, r) {
		e === void 0 && (e = ""), this.path !== void 0 && (e = this.path + e), e = this.manager.resolveURL(e);
		let i = this, a = Za.get(`image-bitmap:${e}`);
		if (a !== void 0) {
			if (i.manager.itemStart(e), a.then) {
				a.then((n) => {
					Mo.has(a) === !0 ? (r && r(Mo.get(a)), i.manager.itemError(e), i.manager.itemEnd(e)) : (t && t(n), i.manager.itemEnd(e));
				});
				return;
			}
			setTimeout(function() {
		...
		let s = fetch(e, o).then(function(e) {
			...
			Za.add(`image-bitmap:${e}`, n), t && t(n), i.manager.itemEnd(e);
		}).catch(function(t) {
			r && r(t), Mo.set(s, t), Za.remove(`image-bitmap:${e}`), i.manager.itemError(e), i.manager.itemEnd(e);
		});
		Za.add(`image-bitmap:${e}`, s), i.manager.itemStart(e);
	}
	abort() {
		return this._abortController.abort(), this._abortController = new AbortController(), this;
	}
}, Po = -90, Fo = 1, Io = class extends An {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new So(Po, Fo, e, t);
		r.layers = this.layers, this.add(r);
		let i = new So(Po, Fo, e, t);
		i.layers = this.layers, this.add(i);
		let a = new So(Po, Fo, e, t);
		a.layers = this.layers, this.add(a);
		let o = new So(Po, Fo, e, t);
		o.layers = this.layers, this.add(o);
		let s = new So(Po, Fo, e, t);
		s.layers = this.layers, this.add(s);
		let c = new So(Po, Fo, e, t);
	...
	_slerp(e, t, n, r) {
		Ft.slerpFlat(e, t, e, t, e, n, r);
	}
	_slerpAdditive(e, t, n, r, i) {
		let a = this._workIndex * i;
		Ft.multiplyQuaternionsFlat(e, a, e, t, e, n), Ft.slerpFlat(e, t, e, t, e, a, r);
	}
	_lerp(e, t, n, r, i) {
		let a = 1 - r;
		for (let o = 0; o !== i; ++o) {
...
}, zo = "\\[\\]\\.:\\/", Bo = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), Vo = "[^\\[\\]\\.:\\/]", Ho = "[^" + zo.replace("\\.", "") + "]", Uo = /*@__PURE__*/ "((?:WC+[\\/:])*)".replace("WC", Vo), Wo = /*@__PURE__*/ "(WCOD+)?".replace("WCOD", Ho), Go = /*@__PURE__*/ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", Vo), Ko = /*@__PURE__*/ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", Vo), qo = RegExp("^" + Uo + Wo + Go + Ko + "$"), Jo = [
	"material",
	"materials",
	"bones",
	"map"
	...
	static parseTrackName(e) {
		...
		if (r !== void 0 && r !== -1) {
			...
			Jo.indexOf(e) !== -1 && (n.nodeName = n.nodeName.substring(0, r), n.objectName = e);
		}
...
Z.Composite = Yo, Z.prototype.BindingType = {
	Direct: 0,
	EntireArray: 1,
	ArrayElement: 2,
	HasFromToArray: 3
}, Z.prototype.Versioning = {
	None: 0,
	NeedsUpdate: 1,
	MatrixWorldNeedsUpdate: 2
}, Z.prototype.GetterByBindingType = [
	Z.prototype._getValue_direct,
	Z.prototype._getValue_array,
	Z.prototype._getValue_arrayElement,
	Z.prototype._getValue_toArray
], Z.prototype.SetterByBindingTypeAndVersioning = [
	[
		Z.prototype._setValue_direct,
		Z.prototype._setValue_direct_setNeedsUpdate,
		Z.prototype._setValue_direct_setMatrixWorldNeedsUpdate
	],
	[
		Z.prototype._setValue_array,
		Z.prototype._setValue_array_setNeedsUpdate,
		Z.prototype._setValue_array_setMatrixWorldNeedsUpdate
	],
	[
		Z.prototype._setValue_arrayElement,
		Z.prototype._setValue_arrayElement_setNeedsUpdate,
		Z.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate
	],
	[
		Z.prototype._setValue_fromArray,
		Z.prototype._setValue_fromArray_setNeedsUpdate,
...
var Xo = class {
	constructor(e, t, n = null, r = t.blendMode) {
		...
		this._interpolantSettings = s, this._interpolants = o, this._propertyBindings = Array(a), this._cacheIndex = null, this._byClipCacheIndex = null, this._timeScaleInterpolant = null, this._restoreTimeScale = null, this._weightInterpolant = null, this.loop = Fe, this._loopCount = -1, this._startTime = null, this.time = 0, this.timeScale = 1, this._effectiveTimeScale = 1, this.weight = 1, this._effectiveWeight = 1, this.repetitions = Infinity, this.paused = !1, this.enabled = !0, this.clampWhenFinished = !1, this.zeroSlopeAtStart = !0, this.zeroSlopeAtEnd = !0;
	}
	play() {
	...
	_updateTime(e) {
		let t = this._clip.duration, n = this.loop, r = this.time + e, i = this._loopCount, a = n === L;
	...
	_setEndings(e, t, n) {
		...
		n ? (r.endingStart = ze, r.endingEnd = ze) : (r.endingStart = e ? this.zeroSlopeAtStart ? ze : Re : Be, r.endingEnd = t ? this.zeroSlopeAtEnd ? ze : Re : Be);
	}
...
}, Zo = /* @__PURE__ */ new Float32Array(1), Qo = class extends lt {
	constructor(e) {
	...
	_bindAction(e, t) {
		...
		for (let e = 0; e !== i; ++e) {
			...
			if (u !== void 0) ++u.referenceCount, a[e] = u;
				...
				u = new Ro(Z.create(n, c, r), i.ValueTypeName, i.getValueSize()), ++u.referenceCount, this._addInactiveBinding(u, s, c), a[e] = u;
			}
	...
	_lendControlInterpolant() {
		...
		return n === void 0 && (n = new La(/* @__PURE__ */ new Float32Array(2), /* @__PURE__ */ new Float32Array(2), 1, Zo), n.__cacheIndex = t, e[t] = n), n;
	}
	...
	clipAction(e, t, n) {
		let r = t || this._root, i = r.uuid, a = typeof e == "string" ? Ja.findByName(r, e) : e, o = a === null ? e : a.uuid, s = this._actionsByClip[o], c = null;
		if (n === void 0 && (n = a === null ? Ve : a.blendMode), s !== void 0) {
			let e = s.actionByRoot[i];
			if (e !== void 0 && e.blendMode === n) return e;
			c = s.knownActions[0], a === null && (a = c._clip);
		}
		if (a === null) return null;
		let l = new Xo(this, a, t, n);
		return this._bindAction(l, c), this._addInactiveAction(l, o, i), l;
	}
	existingAction(e, t) {
		let n = t || this._root, r = n.uuid, i = typeof e == "string" ? Ja.findByName(n, e) : e, a = i ? i.uuid : e, o = this._actionsByClip[a];
...
function rs(e, t, n, r) {
	...
	switch (n) {
		case E: return e * t;
		case j: return e * t / i.components * i.byteLength;
		...
		case D: return e * t * 3 / i.components * i.byteLength;
		case O: return e * t * 4 / i.components * i.byteLength;
		case ne: return e * t * 4 / i.components * i.byteLength;
		case N:
		case re: return Math.floor((e + 3) / 4) * Math.floor((t + 3) / 4) * 8;
		case ie:
		case ae: return Math.floor((e + 3) / 4) * Math.floor((t + 3) / 4) * 16;
		case se:
		case le: return Math.max(e, 16) * Math.max(t, 8) / 4;
		case oe:
		case ce: return Math.max(e, 8) * Math.max(t, 8) / 2;
		case P:
		case ue:
		case fe:
		case pe: return Math.floor((e + 3) / 4) * Math.floor((t + 3) / 4) * 8;
		case de:
		case me:
		...
		case ke: return Math.floor((e + 11) / 12) * Math.floor((t + 11) / 12) * 16;
		case Ae:
		case je:
		case Me: return Math.ceil(e / 4) * Math.ceil(t / 4) * 16;
		case Ne:
		case F: return Math.ceil(e / 4) * Math.ceil(t / 4) * 8;
		case Pe:
...
var Q = {
	...
	points: {
		uniforms: /*@__PURE__*/ va([$.points, $.fog]),
	...
	depth: {
		uniforms: /*@__PURE__*/ va([$.common, $.displacementmap]),
	...
	sprite: {
		uniforms: /*@__PURE__*/ va([$.sprite, $.fog]),
...
ss.physical = {
	uniforms: /*@__PURE__*/ va([ss.standard.uniforms, {
		clearcoat: { value: 0 },
...
var cs = {
	...
	b: 0,
	g: 0
}, ls = /*@__PURE__*/ new Y(), us = /*@__PURE__*/ new K();
us.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function ds(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new ai(new ma(1, 1, 1), new Ta({
			name: "BackgroundCubeMaterial",
			uniforms: _a(ss.backgroundCube.uniforms),
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(ls.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(us), l.material.toneMapped = q.getTransfer(i.colorSpace) !== qe, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new ai(new ha(2, 2), new Ta({
			name: "BackgroundMaterial",
			uniforms: _a(ss.background.uniforms),
	...
	function g(t, r) {
		t.getRGB(cs, xa(e)), n.buffers.color.setClear(cs.r, cs.g, cs.b, r, a);
	}
	function _() {
...
function hs(e) {
	let t = this, n = null, r = 0, i = !1, a = !1, o = new Fi(), s = new K(), c = {
		value: null,
		needsUpdate: !1
	};
...
var gs = 4, _s = [
	...
	.526,
	.582
], vs = 20, ys = 256, bs = /*@__PURE__*/ new Do(), xs = /*@__PURE__*/ new X(), Ss = null, Cs = 0, ws = 0, Ts = !1, Es = /*@__PURE__*/ new G(), Ds = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = Es } = i;
		Ss = this._renderer.getRenderTarget(), Cs = this._renderer.getActiveCubeFace(), ws = this._renderer.getActiveMipmapLevel(), Ts = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(Ss, Cs, ws), this._renderer.xr.enabled = Ts, e.scissorTest = !1, As(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), Ss = this._renderer.getRenderTarget(), Cs = this._renderer.getActiveCubeFace(), ws = this._renderer.getActiveMipmapLevel(), Ts = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = Os(r)), this._blurMaterial = Ms(r, e, t), this._ggxMaterial = js(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
		let t = new ai(new Nr(), e);
		this._renderer.compile(t, bs);
	}
	_sceneToCubeUV(e, t, n, r, i) {
		let a = new So(90, 1, t, n), o = [
			1,
			-1,
			1,
			1,
		...
		c.getClearColor(xs), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new ai(new ma(), new qr({
		...
		m ? m.isColor && (f.color.copy(m), e.background = null, p = !0) : (f.color.copy(xs), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
			...
			As(r, n * l, t > 2 ? l : 0, l, l), c.setRenderTarget(r), p && c.render(d, a), c.render(e, a);
		}
		c.toneMapping = u, c.autoClear = l, e.background = m;
	}
	_textureToCubeUV(e, t) {
		let n = this._renderer, r = e.mapping === 301 || e.mapping === 302;
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = Ps()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = Ns());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		As(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, bs);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - gs ? n - d + gs : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, As(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, bs), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, As(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, bs);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / 39, p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : vs;
		m > vs && B(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${vs}`);
		let h = [], g = 0;
		for (let e = 0; e < vs; ++e) {
		...
		As(t, 3 * v * (r > _ - gs ? r - _ + gs : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, bs);
	}
};
function Os(e) {
	...
	for (let o = 0; o < a; o++) {
		...
		t.push(a);
		let s = 1 / a;
		o > e - gs ? s = _s[o - e + gs - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new Nr();
		h.setAttribute("position", new vr(f, 3)), h.setAttribute("uv", new vr(p, 2)), h.setAttribute("faceIndex", new vr(m, 1)), r.push(new ai(h, null)), i > gs && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
var Is = class extends $t {
	...
	fromEquirectangularTexture(e, t) {
		...
		}, r = new ma(5, 5, 5), i = new Ta({
			name: "CubemapFromEquirect",
			uniforms: _a(n.uniforms),
		...
		let a = new ai(r, i), o = t.minFilter;
		return t.minFilter === 1008 && (t.minFilter = l), new Io(1, 10, this).update(e, a), t.minFilter = o, a.geometry.dispose(), a.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
	...
	function o(t) {
		if (t && t.isTexture) {
			...
			if (a || o) {
				...
				if (t.isRenderTargetTexture && t.pmremVersion !== s) return r === null && (r = new Ds(e)), i = a ? r.fromEquirectangular(t, i) : r.fromCubemap(t, i), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), i.texture;
				if (i !== void 0) return i.texture;
				{
					let s = t.image;
					return a && s && s.height > 0 || o && s && c(s) ? (r === null && (r = new Ds(e)), i = a ? r.fromEquirectangular(t) : r.fromCubemap(t), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), t.addEventListener("dispose", u), i.texture) : null;
				}
			}
		}
		return t;
...
function Hs(e, t, n) {
	...
	function a(a, o, s) {
		...
		if (d === void 0 || d.count !== u) {
			...
			let h = new Float32Array(p * m * 4 * u), g = new en(h, p, m, u);
			g.type = y, g.needsUpdate = !0;
			let _ = f * 4;
			for (let t = 0; t < u; t++) {
...
function Gs(e, t, n, r, i, a) {
	...
	c.setAttribute("position", new xr([
		-1,
		3,
		0,
		-1,
	...
	let l = new Ea({
		...
		depthTest: !1,
		depthWrite: !1
	}), u = new ai(c, l), d = new Do(-1, 1, 1, -1, 0, 1), f = null, p = null, m = !1, h, g = null, _ = [], v = !1;
...
var Ks = /*@__PURE__*/ new Zt(), qs = /*@__PURE__*/ new da(1, 1), Js = /*@__PURE__*/ new en(), Ys = /*@__PURE__*/ new nn(), Xs = /*@__PURE__*/ new ua(), Zs = [], Qs = [], $s = /* @__PURE__ */ new Float32Array(16), ec = /* @__PURE__ */ new Float32Array(9), tc = /* @__PURE__ */ new Float32Array(4);
function nc(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = Zs[i];
	if (a === void 0 && (a = new Float32Array(i), Zs[i] = a), t !== 0) {
		r.toArray(a, 0);
...
function ac(e, t) {
	let n = Qs[t];
	n === void 0 && (n = new Int32Array(t), Qs[t] = n);
...
function uc(e, t) {
	...
	if (r === void 0) {
		...
		if (rc(n, r)) return;
		tc.set(r), e.uniformMatrix2fv(this.addr, !1, tc), ic(n, r);
	}
}
function dc(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (rc(n, r)) return;
		ec.set(r), e.uniformMatrix3fv(this.addr, !1, ec), ic(n, r);
	}
}
function fc(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (rc(n, r)) return;
		$s.set(r), e.uniformMatrix4fv(this.addr, !1, $s), ic(n, r);
	}
}
function pc(e, t) {
	let n = this.cache;
...
function mc(e, t) {
	...
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y) && (e.uniform2i(this.addr, t.x, t.y), n[0] = t.x, n[1] = t.y);
		...
		if (rc(n, t)) return;
		e.uniform2iv(this.addr, t), ic(n, t);
	}
}
function hc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z) && (e.uniform3i(this.addr, t.x, t.y, t.z), n[0] = t.x, n[1] = t.y, n[2] = t.z);
		...
		if (rc(n, t)) return;
		e.uniform3iv(this.addr, t), ic(n, t);
	}
}
function gc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z || n[3] !== t.w) && (e.uniform4i(this.addr, t.x, t.y, t.z, t.w), n[0] = t.x, n[1] = t.y, n[2] = t.z, n[3] = t.w);
		...
		if (rc(n, t)) return;
		e.uniform4iv(this.addr, t), ic(n, t);
	}
}
function _c(e, t) {
	let n = this.cache;
...
function vc(e, t) {
	...
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y) && (e.uniform2ui(this.addr, t.x, t.y), n[0] = t.x, n[1] = t.y);
		...
		if (rc(n, t)) return;
		e.uniform2uiv(this.addr, t), ic(n, t);
	}
}
function yc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z) && (e.uniform3ui(this.addr, t.x, t.y, t.z), n[0] = t.x, n[1] = t.y, n[2] = t.z);
		...
		if (rc(n, t)) return;
		e.uniform3uiv(this.addr, t), ic(n, t);
	}
}
function bc(e, t) {
	let n = this.cache;
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z || n[3] !== t.w) && (e.uniform4ui(this.addr, t.x, t.y, t.z, t.w), n[0] = t.x, n[1] = t.y, n[2] = t.z, n[3] = t.w);
		...
		if (rc(n, t)) return;
		e.uniform4uiv(this.addr, t), ic(n, t);
	}
}
function xc(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (qs.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = qs) : a = Ks, n.setTexture2D(t || a, i);
}
function Sc(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture3D(t || Ys, i);
}
function Cc(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTextureCube(t || Xs, i);
}
function wc(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || Js, i);
}
function Tc(e) {
	switch (e) {
		case 5126: return oc;
...
function Dc(e, t) {
	let n = nc(t, this.size, 2);
	e.uniform2fv(this.addr, n);
}
function Oc(e, t) {
	let n = nc(t, this.size, 3);
	e.uniform3fv(this.addr, n);
}
function kc(e, t) {
	let n = nc(t, this.size, 4);
...
function jc(e, t) {
	let n = nc(t, this.size, 9);
	e.uniformMatrix3fv(this.addr, !1, n);
}
function Mc(e, t) {
	let n = nc(t, this.size, 16);
...
function Vc(e, t, n) {
	let r = this.cache, i = t.length, a = ac(n, i);
	rc(r, a) || (e.uniform1iv(this.addr, a), ic(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? qs : Ks;
	for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || o, a[e]);
}
function Hc(e, t, n) {
	let r = this.cache, i = t.length, a = ac(n, i);
	rc(r, a) || (e.uniform1iv(this.addr, a), ic(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || Ys, a[e]);
}
function Uc(e, t, n) {
	let r = this.cache, i = t.length, a = ac(n, i);
	rc(r, a) || (e.uniform1iv(this.addr, a), ic(r, a));
	for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || Xs, a[e]);
}
function Wc(e, t, n) {
	let r = this.cache, i = t.length, a = ac(n, i);
	rc(r, a) || (e.uniform1iv(this.addr, a), ic(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || Js, a[e]);
}
function Gc(e) {
	switch (e) {
		case 5126: return Ec;
		case 35664: return Dc;
		case 35665: return Oc;
		case 35666: return kc;
		case 35674: return Ac;
		case 35675: return jc;
		case 35676: return Mc;
		case 5124:
		case 35670: return Nc;
		case 35667:
		case 35671: return Pc;
		case 35668:
		case 35672: return Fc;
		case 35669:
		case 35673: return Ic;
		case 5125: return Lc;
		case 36294: return Rc;
...
var Kc = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.setValue = Tc(t.type);
	}
}, qc = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = Gc(t.type);
	}
}, Jc = class {
	constructor(e) {
...
function Zc(e, t, n) {
	...
	for (Yc.lastIndex = 0;;) {
		let a = Yc.exec(r), o = Yc.lastIndex, s = a[1], c = a[2] === "]", l = a[3];
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			Xc(n, l === void 0 ? new Kc(s, e, t) : new qc(s, e, t));
			break;
		}
		{
			let e = n.map[s];
			e === void 0 && (e = new Jc(s), Xc(n, e)), n = e;
		}
	}
}
var Qc = class {
	constructor(e, t) {
		...
		for (let r = 0; r < n; ++r) {
			...
			Zc(n, e.getUniformLocation(t, n.name), this);
		}
		let r = [], i = [];
...
var rl = /*@__PURE__*/ new K();
function il(e) {
	q._getMatrix(rl, q.workingColorSpace, e);
	let t = `mat3( ${rl.elements.map((e) => e.toFixed(4))} )`;
	switch (q.getTransfer(e)) {
		case Ke: return [t, "LinearTransferOETF"];
...
var ll = /*@__PURE__*/ new G();
function ul() {
	return q.getLuminanceCoefficients(ll), [
		"float luminance( const in vec3 rgb ) {",
		`	const vec3 weights = vec3( ${ll.x.toFixed(4)}, ${ll.y.toFixed(4)}, ${ll.z.toFixed(4)} );`,
		"	return dot( weights, rgb );",
		"}"
	].join("\n");
}
function dl(e) {
	return [e.extensionClipCullDistance ? "#extension GL_ANGLE_clip_cull_distance : require" : "", e.extensionMultiDraw ? "#extension GL_ANGLE_multi_draw : require" : ""].filter(ml).join("\n");
}
function fl(e) {
	let t = [];
	for (let n in e) {
...
var _l = /^[ \t]*#include +<([\w\d./]+)>/gm;
function vl(e) {
	return e.replace(_l, bl);
}
...
function El(e) {
	return Tl[e.shadowMapType] || "SHADOWMAP_TYPE_BASIC";
}
var Dl = {
...
function Ol(e) {
	return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : Dl[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
...
function Pl(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = El(n), l = Ol(n), u = Al(n), d = Ml(n), f = Nl(n), p = dl(n), m = fl(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	n.isRawShaderMaterial ? (g = [
		...
		ol("linearToOutputTexel", n.outputColorSpace),
		ul(),
	...
	let y = v + g + o, b = v + _ + s, x = $c(i, i.VERTEX_SHADER, y), S = $c(i, i.FRAGMENT_SHADER, b);
	...
	function C(t) {
		if (e.debug.checkShaderErrors) {
			...
			if (i.getProgramParameter(h, i.LINK_STATUS) === !1) {
				if (l = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(i, h, x, S);
					...
					let e = al(i, x, "vertex"), n = al(i, S, "fragment");
		...
		i.deleteShader(x), i.deleteShader(S), w = new Qc(i, h), T = pl(i, h);
	}
	let w;
	...
	return this.isReady = function() {
		return E === !1 && (E = i.getProgramParameter(h, el)), E;
...
var Fl = 0, Il = class {
	...
	_getShaderStage(e) {
		...
		return n === void 0 && (n = new Ll(e), t.set(e, n)), n;
	}
}, Ll = class {
	constructor(e) {
...
function zl(e, t, n, r, i, a) {
	let o = new mn(), s = new Il(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let I = {
			...
			packedNormalMap: se && i.normalMapType === 0 && Rl(i.normalMap.format),
			metalnessMap: P,
			roughnessMap: ue,
			anisotropy: de,
			anisotropyMap: _e,
			...
			pointsUvs: h.isPoints === !0 && !!v.attributes.uv && (ne || je),
			fog: !!_,
			useFog: i.fog === !0,
			...
			toneMapping: Pe,
			decodeVideoTexture: ne && i.map.isVideoTexture === !0 && q.getTransfer(i.map.colorSpace) === "srgb",
			...
			extensionClipCullDistance: F && i.extensions.clipCullDistance === !0 && n.has("WEBGL_clip_cull_distance"),
			extensionMultiDraw: (F && i.extensions.multiDraw === !0 || te) && n.has("WEBGL_multi_draw"),
	...
	function b(t, n) {
		let r = u.get(n);
		return r === void 0 ? (r = new Pl(e, n, t, i), l.push(r), u.set(n, r)) : ++r.usedTimes, r;
	}
	function x(e) {
		if (--e.usedTimes === 0) {
			let t = l.indexOf(e);
...
function Ul() {
	...
	function u(e, t, a) {
		n.length > 1 && n.sort(e || Vl), r.length > 1 && r.sort(t || Hl), i.length > 1 && i.sort(t || Hl), a && (n.reverse(), r.reverse(), i.reverse());
	}
	function d() {
...
function Wl() {
	...
	function t(t, n) {
		let r = e.get(t), i;
		return r === void 0 ? (i = new Ul(), e.set(t, [i])) : n >= r.length ? (i = new Ul(), r.push(i)) : i = r[n], i;
	}
	function n() {
		e = /* @__PURE__ */ new WeakMap();
	}
...
function Zl(e) {
	...
	function n(n, r = 0) {
		let i = t.get(n), a;
		return i === void 0 ? (a = new Xl(e), t.set(n, [a])) : r >= i.length ? (a = new Xl(e), i.push(a)) : a = i[r], a;
	}
	function r() {
...
var Ql = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", $l = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", eu = [
	...
	/*@__PURE__*/ new G(0, -1, 0),
	/*@__PURE__*/ new G(0, -1, 0)
], nu = /*@__PURE__*/ new Y(), ru = /*@__PURE__*/ new G(), iu = /*@__PURE__*/ new G();
function au(e, t, n) {
	let r = new zi(), i = new W(), a = new W(), s = new J(), c = new ka(), u = new Aa(), d = {}, f = n.maxTextureSize, p = {
		0: 1,
		1: 0,
		2: 2
	}, m = new Ta({
			...
			if (p.camera._reversedDepth = _, p.map === null || h === !0) {
				if (p.map !== null && (p.map.depthTexture !== null && (p.map.depthTexture.dispose(), p.map.depthTexture = null), p.map.dispose()), this.type === 3) {
					...
					p.map = new $t(i.x, i.y, {
						...
						magFilter: l,
						generateMipmaps: !1
					}), p.map.texture.name = d.name + ".shadowMap", p.map.depthTexture = new da(i.x, i.y, y), p.map.depthTexture.name = d.name + ".shadowMapDepth", p.map.depthTexture.format = k, p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = o, p.map.depthTexture.magFilter = o;
				} else d.isPointLight ? (p.map = new Is(i.x), p.map.depthTexture = new fa(i.x, v)) : (p.map = new $t(i.x, i.y), p.map.depthTexture = new da(i.x, i.y, v)), p.map.depthTexture.name = d.name + ".shadowMap", p.map.depthTexture.format = k, this.type === 1 ? (p.map.depthTexture.compareFunction = _ ? 518 : 515, p.map.depthTexture.minFilter = l, p.map.depthTexture.magFilter = l) : (p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = o, p.map.depthTexture.magFilter = o);
	...
	function C(n, r) {
		let a = t.update(_);
		m.defines.VSM_SAMPLES !== n.blurSamples && (m.defines.VSM_SAMPLES = n.blurSamples, h.defines.VSM_SAMPLES = n.blurSamples, m.needsUpdate = !0, h.needsUpdate = !0), n.mapPass === null && (n.mapPass = new $t(i.x, i.y, {
			format: M,
			type: b
...
function ou(e, t) {
	...
	let N = null, re = {}, ie = e.getParameter(e.SCISSOR_BOX), ae = e.getParameter(e.VIEWPORT), oe = new J().fromArray(ie), se = new J().fromArray(ae);
	function ce(t, n, r, i) {
	...
	function xe(t, n, r) {
		t ? (P(e.POLYGON_OFFSET_FILL), (A !== n || j !== r) && (A = n, j = r, o.getReversed() && (n = -n), e.polygonOffset(n, r))) : ue(e.POLYGON_OFFSET_FILL);
	}
	function Se(t) {
	...
	function we(t, n, r) {
		...
		i === void 0 && (i = {
			type: void 0,
			texture: void 0
		}, re[r] = i), (i.type !== t || i.texture !== n) && (N !== r && (e.activeTexture(r), N = r), e.bindTexture(t, n || le[t]), i.type = t, i.texture = n);
	}
	function Te() {
		let t = re[N];
	...
	function Le() {
		e.disable(e.BLEND), e.disable(e.CULL_FACE), e.disable(e.DEPTH_TEST), e.disable(e.POLYGON_OFFSET_FILL), e.disable(e.SCISSOR_TEST), e.disable(e.STENCIL_TEST), e.disable(e.SAMPLE_ALPHA_TO_COVERAGE), e.blendEquation(e.FUNC_ADD), e.blendFunc(e.ONE, e.ZERO), e.blendFuncSeparate(e.ONE, e.ZERO, e.ONE, e.ZERO), e.blendColor(0, 0, 0, 0), e.colorMask(!0, !0, !0, !0), e.clearColor(0, 0, 0, 0), e.depthMask(!0), e.depthFunc(e.LESS), o.setReversed(!1), e.clearDepth(1), e.stencilMask(4294967295), e.stencilFunc(e.ALWAYS, 0, 4294967295), e.stencilOp(e.KEEP, e.KEEP, e.KEEP), e.clearStencil(0), e.cullFace(e.BACK), e.frontFace(e.CCW), e.polygonOffset(0, 0), e.activeTexture(e.TEXTURE0), e.bindFramebuffer(e.FRAMEBUFFER, null), e.bindFramebuffer(e.DRAW_FRAMEBUFFER, null), e.bindFramebuffer(e.READ_FRAMEBUFFER, null), e.useProgram(null), e.lineWidth(1), e.scissor(0, 0, e.canvas.width, e.canvas.height), e.viewport(0, 0, e.canvas.width, e.canvas.height), e.pixelStorei(e.PACK_ALIGNMENT, 4), e.pixelStorei(e.UNPACK_ALIGNMENT, 4), e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, !1), e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !1), e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL, e.BROWSER_DEFAULT_WEBGL), e.pixelStorei(e.PACK_ROW_LENGTH, 0), e.pixelStorei(e.PACK_SKIP_PIXELS, 0), e.pixelStorei(e.PACK_SKIP_ROWS, 0), e.pixelStorei(e.UNPACK_ROW_LENGTH, 0), e.pixelStorei(e.UNPACK_IMAGE_HEIGHT, 0), e.pixelStorei(e.UNPACK_SKIP_PIXELS, 0), e.pixelStorei(e.UNPACK_SKIP_ROWS, 0), e.pixelStorei(e.UNPACK_SKIP_IMAGES, 0), u = {}, d = {}, N = null, re = {}, f = {}, p = /* @__PURE__ */ new WeakMap(), m = [], h = null, g = !1, _ = null, v = null, y = null, b = null, x = null, S = null, C = null, w = new X(0, 0, 0), T = 0, E = !1, D = null, O = null, k = null, A = null, j = null, oe.set(0, 0, e.canvas.width, e.canvas.height), se.set(0, 0, e.canvas.width, e.canvas.height), a.reset(), o.reset(), s.reset();
	}
	return {
		buffers: {
			color: a,
...
function su(e, t, n, f, p, m, h) {
	...
	function w(e, t) {
		return C ? new OffscreenCanvas(e, t) : tt("canvas");
	}
	function T(e, t, n) {
		let r = 1, i = I(e);
	...
	function ne(e) {
		...
		if (r) {
			...
			i.usedTimes--, i.usedTimes === 0 && N(e), Object.keys(r).length === 0 && S.delete(n);
		}
		f.remove(e);
	}
	function N(t) {
	...
	function ce() {
		let e = ie;
		return e >= p.maxTextures && B("WebGLTextures: Trying to use " + e + " texture units while this GPU supports only " + p.maxTextures), ie += 1, e;
	}
	function le(e) {
		let t = [];
	...
	function P(t, r) {
		let i = f.get(t);
		if (t.isVideoTexture && F(t), t.isRenderTargetTexture === !1 && t.isExternalTexture !== !0 && t.version > 0 && i.__version !== t.version) {
			let e = t.image;
	...
	function be(t, r, i) {
		...
		if (s.version !== c.__version || o === !0) {
			...
			t = Pe(r, t);
			let l = m.convert(r.format, r.colorSpace), u = m.convert(r.type), d = k(r.internalFormat, l, u, r.normalized, r.colorSpace, r.isVideoTexture);
			ge(a, r);
			let f, h = r.mipmaps, g = r.isVideoTexture !== !0, _ = c.__version === void 0 || o === !0, v = s.dataReady, y = ee(r, t);
			if (r.isDepthTexture) d = j(r.format === A, r.type), _ && (g ? n.texStorage2D(e.TEXTURE_2D, 1, d, t.width, t.height) : n.texImage2D(e.TEXTURE_2D, 0, d, t.width, t.height, 0, l, u, null));
				...
				if (r.isCompressedArrayTexture) {
					...
					for (let i = 0, a = h.length; i < a; i++) if (f = h[i], r.format !== 1023) {
						if (l !== null) {
							if (g) {
								if (v) {
									if (r.layerUpdates.size > 0) {
										let t = rs(f.width, f.height, r.format, r.type);
				...
				if (g) {
					if (_ && n.texStorage3D(e.TEXTURE_2D_ARRAY, y, d, t.width, t.height, t.depth), v) {
						if (r.layerUpdates.size > 0) {
							let i = rs(t.width, t.height, r.format, r.type);
							for (let a of r.layerUpdates) {
				...
				if (_) {
					if (g) n.texStorage2D(e.TEXTURE_2D, y, d, t.width, t.height);
					else {
	...
	function xe(t, r, i) {
		...
		if (o.version !== s.__version || a === !0) {
			...
			for (let e = 0; e < 6; e++) !u && !d ? f[e] = T(r.image[e], !0, p.maxCubemapSize) : f[e] = d ? r.image[e].image : r.image[e], f[e] = Pe(r, f[e]);
			let h = f[0], g = m.convert(r.format, r.colorSpace), _ = m.convert(r.type), v = k(r.internalFormat, g, _, r.normalized, r.colorSpace), y = r.isVideoTexture !== !0, b = s.__version === void 0 || a === !0, x = o.dataReady, S = ee(r, h);
	...
	function Se(t, r, i, a, o, s) {
		let c = m.convert(i.format, i.colorSpace), l = m.convert(i.type), u = k(i.internalFormat, c, l, i.normalized, i.colorSpace), d = f.get(r), p = f.get(i);
		...
		n.bindFramebuffer(e.FRAMEBUFFER, t), Ne(r) ? g.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, a, o, p.__webglTexture, 0, Me(r)) : (o === e.TEXTURE_2D || o >= e.TEXTURE_CUBE_MAP_POSITIVE_X && o <= e.TEXTURE_CUBE_MAP_NEGATIVE_Z) && e.framebufferTexture2D(e.FRAMEBUFFER, a, o, p.__webglTexture, s), n.bindFramebuffer(e.FRAMEBUFFER, null);
	}
	function Ce(t, n, r) {
		if (e.bindRenderbuffer(e.RENDERBUFFER, t), n.depthBuffer) {
			...
			Ne(n) ? g.renderbufferStorageMultisampleEXT(e.RENDERBUFFER, Me(n), o, n.width, n.height) : r ? e.renderbufferStorageMultisample(e.RENDERBUFFER, Me(n), o, n.width, n.height) : e.renderbufferStorage(e.RENDERBUFFER, o, n.width, n.height), e.framebufferRenderbuffer(e.FRAMEBUFFER, s, e.RENDERBUFFER, t);
		} else {
			let t = n.textures;
			for (let i = 0; i < t.length; i++) {
				let a = t[i], o = m.convert(a.format, a.colorSpace), s = m.convert(a.type), c = k(a.internalFormat, o, s, a.normalized, a.colorSpace);
				Ne(n) ? g.renderbufferStorageMultisampleEXT(e.RENDERBUFFER, Me(n), c, n.width, n.height) : r ? e.renderbufferStorageMultisample(e.RENDERBUFFER, Me(n), c, n.width, n.height) : e.renderbufferStorage(e.RENDERBUFFER, c, n.width, n.height);
			}
		}
	...
	function we(t, r, i) {
		...
		if (o.__renderTarget = r, (!o.__webglTexture || r.depthTexture.image.width !== r.width || r.depthTexture.image.height !== r.height) && (r.depthTexture.image.width = r.width, r.depthTexture.image.height = r.height, r.depthTexture.needsUpdate = !0), a) {
			if (o.__webglInit === void 0 && (o.__webglInit = !0, r.depthTexture.addEventListener("dispose", M)), o.__webglTexture === void 0) {
		...
		let s = o.__webglTexture, c = Me(r), l = a ? e.TEXTURE_CUBE_MAP_POSITIVE_X + i : e.TEXTURE_2D, u = r.depthTexture.format === 1027 ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT;
		if (r.depthTexture.format === 1026) Ne(r) ? g.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, u, l, s, 0, c) : e.framebufferTexture2D(e.FRAMEBUFFER, u, l, s, 0);
		else if (r.depthTexture.format === 1027) Ne(r) ? g.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, u, l, s, 0, c) : e.framebufferTexture2D(e.FRAMEBUFFER, u, l, s, 0);
	...
	function Te(t) {
		...
		if (t.depthTexture && !r.__autoAllocateDepthBuffer) {
			if (i) for (let e = 0; e < 6; e++) we(r.__webglFramebuffer[e], t, e);
			else {
		...
		if (c || (a.__webglTexture === void 0 && (a.__webglTexture = e.createTexture()), a.__version = r.version, h.memory.textures++), s) {
			...
			if (t.samples > 0 && Ne(t) === !1) {
				...
				for (let n = 0; n < o.length; n++) {
					...
					let a = m.convert(r.format, r.colorSpace), s = m.convert(r.type), c = k(r.internalFormat, a, s, r.normalized, r.colorSpace, t.isXRRenderTarget === !0), l = Me(t);
...
var lu = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", uu = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", du = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			let t = e.cameras[0].viewport, n = new Ta({
				vertexShader: lu,
				fragmentShader: uu,
				uniforms: {
			...
			this.mesh = new ai(new ha(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, o = "local-floor", s = 1, c = null, l = null, u = null, d = null, f = null, m = null, h = typeof XRWebGLBinding < "u", g = new du(), _ = {}, y = t.getContextAttributes(), b = null, x = null, S = [], w = [], T = new W(), E = null, D = new So();
		D.viewport = new J();
		let j = new So();
		j.viewport = new J();
		let ee = [D, j], M = new Lo(), te = null, ne = null;
		...
		function re() {
			...
			for (let e = 0; e < S.length; e++) {
				let t = w[e];
				t !== null && (w[e] = null, S[e].disconnect(t));
			}
			te = null, ne = null, g.reset();
			for (let e in _) delete _[e];
			e.setRenderTarget(b), f = null, d = null, u = null, r = null, x = null, de.stop(), n.isPresenting = !1, e.setPixelRatio(E), e.setSize(T.width, T.height, !1), n.dispatchEvent({ type: "sessionend" });
		}
		this.setFramebufferScaleFactor = function(e) {
			...
			if (r = l, r !== null) {
				if (b = e.getRenderTarget(), r.addEventListener("select", N), r.addEventListener("selectstart", N), r.addEventListener("selectend", N), r.addEventListener("squeeze", N), r.addEventListener("squeezestart", N), r.addEventListener("squeezeend", N), r.addEventListener("end", re), r.addEventListener("inputsourceschange", ie), y.xrCompatible !== !0 && await t.makeXRCompatible(), E = e.getPixelRatio(), e.getSize(T), h && "createProjectionLayer" in XRWebGLBinding.prototype) {
					...
					y.depth && (o = y.stencil ? t.DEPTH24_STENCIL8 : t.DEPTH_COMPONENT24, n = y.stencil ? A : k, a = y.stencil ? C : v);
					let s = {
						colorFormat: t.RGBA8,
						depthFormat: o,
						scaleFactor: i
					};
					u = this.getBinding(), d = u.createProjectionLayer(s), r.updateRenderState({ layers: [d] }), e.setPixelRatio(1), e.setSize(d.textureWidth, d.textureHeight, !1), x = new $t(d.textureWidth, d.textureHeight, {
						format: O,
						type: p,
					...
					f = new XRWebGLLayer(r, t, n), r.updateRenderState({ baseLayer: f }), e.setPixelRatio(1), e.setSize(f.framebufferWidth, f.framebufferHeight, !1), x = new $t(f.framebufferWidth, f.framebufferHeight, {
						format: O,
						type: p,
						colorSpace: e.outputColorSpace,
						stencilBuffer: y.stencil,
		...
		function ie(e) {
			for (let t = 0; t < e.removed.length; t++) {
				...
				r >= 0 && (w[r] = null, S[r].disconnect(n));
			}
			for (let t = 0; t < e.added.length; t++) {
				let n = e.added[t], r = w.indexOf(n);
				if (r === -1) {
					for (let e = 0; e < S.length; e++) if (e >= w.length) {
						w.push(n), r = e;
						break;
					} else if (w[e] === null) {
						w[e] = n, r = e;
		...
		this.updateCamera = function(e) {
			...
			g.texture !== null && (g.depthNear > 0 && (t = g.depthNear), g.depthFar > 0 && (n = g.depthFar)), M.near = j.near = D.near = t, M.far = j.far = D.far = n, (te !== M.near || ne !== M.far) && (r.updateRenderState({
				depthNear: M.near,
				depthFar: M.far
			}), te = M.near, ne = M.far), M.layers.mask = e.layers.mask | 6, D.layers.mask = M.layers.mask & -5, j.layers.mask = M.layers.mask & -3;
			let i = e.parent, a = M.cameras;
			ce(M, i);
			for (let e = 0; e < a.length; e++) ce(a[e], i);
			a.length === 2 ? se(M, D, j) : M.projectionMatrix.copy(D.projectionMatrix), le(e, M, i);
		};
		function le(e, t, n) {
...
}, pu = /*@__PURE__*/ new Y(), mu = /*@__PURE__*/ new K();
mu.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function hu(e, t) {
	function n(e, t) {
		e.matrixAutoUpdate === !0 && e.updateMatrix(), t.value.copy(e.matrix);
	}
	function r(t, n) {
		n.color.getRGB(t.fogColor.value, xa(e)), n.isFog ? (t.fogNear.value = n.near, t.fogFar.value = n.far) : n.isFogExp2 && (t.fogDensity.value = n.density);
	}
	...
	function a(e, r) {
		...
		a && (e.envMap.value = a, e.envMapRotation.value.setFromMatrix4(pu.makeRotationFromEuler(o)).transpose(), a.isCubeTexture && a.isRenderTargetTexture === !1 && e.envMapRotation.value.premultiply(mu), e.reflectivity.value = r.reflectivity, e.ior.value = r.ior, e.refractionRatio.value = r.refractionRatio), r.lightMap && (e.lightMap.value = r.lightMap, e.lightMapIntensity.value = r.lightMapIntensity, n(r.lightMap, e.lightMapTransform)), r.aoMap && (e.aoMap.value = r.aoMap, e.aoMapIntensity.value = r.aoMapIntensity, n(r.aoMap, e.aoMapTransform));
	}
	function o(e, t) {
...
function yu() {
	return vu === null && (vu = new yi(_u, 16, 16, M, b), vu.name = "DFG_LUT", vu.minFilter = l, vu.magFilter = l, vu.wrapS = i, vu.wrapT = i, vu.generateMipmaps = !1, vu.needsUpdate = !0), vu;
}
var bu = class {
	constructor(e = {}) {
		let { canvas: t = nt(), context: n = null, depth: r = !0, stencil: i = !1, alpha: a = !1, antialias: o = !1, premultipliedAlpha: s = !0, preserveDrawingBuffer: c = !1, powerPreference: l = "default", failIfMajorPerformanceCaveat: u = !1, reversedDepthBuffer: f = !1, outputBufferType: m = p } = e;
		...
		let _ = m, y = /* @__PURE__ */ new Set([
			...
			x,
			S
		]), T = /* @__PURE__ */ new Uint32Array(4), E = /* @__PURE__ */ new Int32Array(4), D = new G(), O = null, k = null, A = [], j = [], M = null;
		this.domElement = t, this.debug = {
			checkShaderErrors: !0,
			onShaderError: null
		}, this.autoClear = !0, this.autoClearColor = !0, this.autoClearDepth = !0, this.autoClearStencil = !0, this.sortObjects = !0, this.clippingPlanes = [], this.localClippingEnabled = !1, this.toneMapping = 0, this.toneMappingExposure = 1, this.transmissionResolutionScale = 1;
		let N = this, re = !1, ie = null, ae = null, oe = null, se = null;
		this._outputColorSpace = We;
		let ce = 0, le = 0, P = null, ue = -1, de = null, fe = new J(), pe = new J(), me = null, he = new X(0), ge = 0, _e = t.width, ve = t.height, ye = 1, be = null, xe = null, Se = new J(0, 0, _e, ve), Ce = new J(0, 0, _e, ve), we = !1, Te = new zi(), Ee = !1, De = !1, Oe = new Y(), ke = new G(), Ae = new J(), je = {
			background: null,
			fog: null,
			environment: null,
		...
		try {
			...
			if ("setAttribute" in t && t.setAttribute("data-engine", "three.js r185"), t.addEventListener("webglcontextlost", ot, !1), t.addEventListener("webglcontextrestored", ct, !1), t.addEventListener("webglcontextcreationerror", lt, !1), F === null) {
				let t = "webgl2";
		...
		let I, Fe, L, Ie, R, z, Le, Re, ze, Be, Ve, He, Ue, Ge, Ke, qe, Je, Ye, Xe, Ze, $e, et, tt;
		function rt() {
			I = new Rs(F), I.init(), $e = new cu(F, I), Fe = new ms(F, I, e, $e), L = new ou(F, I), Fe.reversedDepthBuffer && f && L.buffers.depth.setReversed(!0), ae = F.createFramebuffer(), oe = F.createFramebuffer(), se = F.createFramebuffer(), Ie = new Vs(F), R = new Bl(), z = new su(F, I, L, R, Fe, $e, Ie), Le = new Ls(N), Re = new os(F), et = new fs(F, Re), ze = new zs(F, Re, Ie, et), Be = new Us(F, ze, Re, et, Ie), Ye = new Hs(F, Fe, z), Ke = new hs(R), Ve = new zl(N, Le, I, Fe, et, Ke), He = new hu(N, R), Ue = new Wl(), Ge = new Zl(I), Je = new ds(N, Le, L, Be, h, s), qe = new au(N, Be, Fe), tt = new gu(F, Ie, Fe, L), Xe = new ps(F, I, Ie), Ze = new Bs(F, I, Ie), Ie.programs = Ve.programs, N.capabilities = Fe, N.extensions = I, N.properties = R, N.renderLists = Ue, N.shadowMap = qe, N.state = L, N.info = Ie;
		}
		rt(), _ !== 1009 && (M = new Gs(_, t.width, t.height, o, r, i));
		let at = new fu(N, F);
		this.xr = at, this.getContext = function() {
			...
			_e = e, ve = n, t.width = Math.floor(e * ye), t.height = Math.floor(n * ye), r === !0 && (t.style.width = e + "px", t.style.height = n + "px"), M !== null && M.setSize(t.width, t.height), this.setViewport(0, 0, e, n);
			...
			e.isVector4 ? Se.set(e.x, e.y, e.z, e.w) : Se.set(e, t, n, r), L.viewport(fe.copy(Se).multiplyScalar(ye).round());
		}, this.getScissor = function(e) {
			return e.copy(Ce);
		}, this.setScissor = function(e, t, n, r) {
			e.isVector4 ? Ce.set(e.x, e.y, e.z, e.w) : Ce.set(e, t, n, r), L.scissor(pe.copy(Ce).multiplyScalar(ye).round());
		}, this.getScissorTest = function() {
			return we;
		}, this.setScissorTest = function(e) {
			L.setScissorTest(we = e);
			...
			if (e) {
				...
				if (e) {
					let e = P.texture.type, t = w.has(e), n = Je.getClearColor(), r = Je.getClearAlpha(), i = n.r, a = n.g, o = n.b;
		...
		function ot(e) {
			e.preventDefault(), it("WebGLRenderer: Context Lost."), re = !0;
		}
		function ct() {
			it("WebGLRenderer: Context Restored."), re = !1;
			let e = Ie.autoReset, t = qe.enabled, n = qe.autoUpdate, r = qe.needsUpdate, i = qe.type;
			rt(), Ie.autoReset = e, qe.enabled = t, qe.autoUpdate = n, qe.needsUpdate = r, qe.type = i;
		}
		function lt(e) {
		...
		this.renderBufferDirect = function(e, t, n, r, i, a) {
			...
			et.setup(i, r, s, n, c);
			let h, g = Xe;
			if (c !== null && (h = Re.get(c), g = Ze, g.setIndex(h)), i.isMesh) r.wireframe === !0 ? (L.setLineWidth(r.wireframeLinewidth * Ne()), g.setMode(F.LINES)) : g.setMode(F.TRIANGLES);
			else if (i.isLine) {
				let e = r.linewidth;
				e === void 0 && (e = 1), L.setLineWidth(e * Ne()), i.isLineSegments ? g.setMode(F.LINES) : i.isLineLoop ? g.setMode(F.LINE_LOOP) : g.setMode(F.LINE_STRIP);
			} else i.isPoints ? g.setMode(F.POINTS) : i.isSprite && g.setMode(F.TRIANGLES);
			if (i.isBatchedMesh) {
				if (I.get("WEBGL_multi_draw")) g.renderMultiDraw(i._multiDrawStarts, i._multiDrawCounts, i._multiDrawCount);
				else {
		...
		this.compile = function(e, t, n = null) {
			n === null && (n = e), k = Ge.get(n), k.init(t), j.push(k), n.traverseVisible(function(e) {
		...
		let _t = new as();
		_t.setAnimationLoop(H), typeof self < "u" && _t.setContext(self), this.setAnimationLoop = function(e) {
			mt = e, at.setAnimationLoop(e), e === null ? _t.stop() : _t.start();
			...
			let n = at.enabled === !0 && at.isPresenting === !0, r = M !== null && (P === null || n) && M.begin(N, P);
			if (e.matrixWorldAutoUpdate === !0 && e.updateMatrixWorld(), t.parent === null && t.matrixWorldAutoUpdate === !0 && t.updateMatrixWorld(), at.enabled === !0 && at.isPresenting === !0 && (M === null || M.isCompositing() === !1) && (at.cameraAutoUpdate === !0 && at.updateCamera(t), t = at.getCamera()), e.isScene === !0 && e.onBeforeRender(N, e, t, P), k = Ge.get(e, j.length), k.init(t), k.state.textureUnits = z.getTextureUnits(), j.push(k), Oe.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), Te.setFromProjectionMatrix(Oe, Qe, t.reversedDepth), De = this.localClippingEnabled, Ee = Ke.init(this.clippingPlanes, De), O = Ue.get(e, A.length), O.init(), A.push(O), at.enabled === !0 && at.isPresenting === !0) {
				...
				e !== null && vt(e, t, -Infinity, N.sortObjects);
			}
			vt(e, t, 0, N.sortObjects), O.finish(), N.sortObjects === !0 && O.sort(be, xe, t.reversedDepth), Me = at.enabled === !1 || at.isPresenting === !1 || at.hasDepthSensing() === !1, Me && Je.addToRenderList(O, e), this.info.render.frame++, this.info.autoReset === !0 && this.info.reset(), Ee === !0 && Ke.beginShadows();
			let i = k.state.shadowsArray;
			if (qe.render(i, e, t), Ee === !0 && Ke.endShadows(), (r && M.hasRenderPass()) === !1) {
				...
				} else r.length > 0 && bt(n, r, e, t), Me && Je.render(e), yt(O, e, t);
			}
			...
			if (e.layers.test(t.layers)) {
				if (e.isGroup) n = e.renderOrder;
					...
					if (!e.frustumCulled || Te.intersectsSprite(e)) {
						...
						i.visible && O.push(e, t, i, n, Ae.z, null);
					}
				} else if ((e.isMesh || e.isLine || e.isPoints) && (!e.frustumCulled || Te.intersectsObject(e))) {
					let t = Be.update(e), i = e.material;
					if (r && (e.boundingSphere === void 0 ? (t.boundingSphere === null && t.computeBoundingSphere(), Ae.copy(t.boundingSphere.center)) : (e.boundingSphere === null && e.computeBoundingSphere(), Ae.copy(e.boundingSphere.center)), Ae.applyMatrix4(e.matrixWorld).applyMatrix4(Oe)), Array.isArray(i)) {
						let r = t.groups;
						for (let a = 0, o = r.length; a < o; a++) {
							let o = r[a], s = i[o.materialIndex];
							s && s.visible && O.push(e, t, s, n, Ae.z, o);
						}
					} else i.visible && O.push(e, t, i, n, Ae.z, null);
				}
			}
			let i = e.children;
		...
		function yt(e, t, n, r) {
			...
			k.setupLightsView(n), Ee === !0 && Ke.setGlobalState(N.clippingPlanes, n), r && L.viewport(fe.copy(r)), i.length > 0 && xt(i, t, n), a.length > 0 && xt(a, t, n), o.length > 0 && xt(o, t, n), L.buffers.depth.setTest(!0), L.buffers.depth.setMask(!0), L.buffers.color.setMask(!0), L.setPolygonOffset(!1);
		}
		function bt(e, t, n, r) {
			...
			if (k.state.transmissionRenderTarget[r.id] === void 0) {
				...
				k.state.transmissionRenderTarget[r.id] = new $t(1, 1, {
					generateMipmaps: !0,
					type: e ? b : p,
					minFilter: d,
			...
			let a = k.state.transmissionRenderTarget[r.id], o = r.viewport || fe;
			...
			N.setRenderTarget(a), N.getClearColor(he), ge = N.getClearAlpha(), ge < 1 && N.setClearColor(16777215, .5), N.clear(), Me && Je.render(n);
			let u = N.toneMapping;
			N.toneMapping = 0;
			let f = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), k.setupLightsView(r), Ee === !0 && Ke.setGlobalState(N.clippingPlanes, r), xt(e, n, r), z.updateMultisampleRenderTarget(a), z.updateRenderTargetMipmap(a), I.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
			...
			N.setRenderTarget(s, c, l), N.setClearColor(he, ge), f !== void 0 && (r.viewport = f), N.toneMapping = u;
		}
		function xt(e, t, n) {
		...
		function Ct(e, t, n) {
			t.isScene !== !0 && (t = je);
			let r = R.get(e), i = k.state.lights, a = k.state.shadowsArray, o = i.state.version, s = Ve.getParameters(e, i.state, a, t, n, k.state.lightProbeGridArray), c = Ve.getProgramCacheKey(s), l = r.programs;
			...
			} else s.uniforms = Ve.getUniforms(e), ie !== null && e.isNodeMaterial && ie.build(e, n, s), e.onBeforeCompile(s, N), d = Ve.acquireProgram(s, c), l.set(c, d), r.uniforms = s.uniforms;
			let f = r.uniforms;
			return (!e.isShaderMaterial && !e.isRawShaderMaterial || e.clipping === !0) && (f.clippingPlanes = Ke.uniform), Tt(e, s), r.needsLights = kt(e), r.lightsStateVersion = o, r.needsLights && (f.ambientLightColor.value = i.state.ambient, f.lightProbe.value = i.state.probe, f.directionalLights.value = i.state.directional, f.directionalLightShadows.value = i.state.directionalShadow, f.spotLights.value = i.state.spot, f.spotLightShadows.value = i.state.spotShadow, f.rectAreaLights.value = i.state.rectArea, f.ltc_1.value = i.state.rectAreaLTC1, f.ltc_2.value = i.state.rectAreaLTC2, f.pointLights.value = i.state.point, f.pointLightShadows.value = i.state.pointShadow, f.hemisphereLights.value = i.state.hemi, f.directionalShadowMatrix.value = i.state.directionalShadowMatrix, f.spotLightMatrix.value = i.state.spotLightMatrix, f.spotLightMap.value = i.state.spotLightMap, f.pointShadowMatrix.value = i.state.pointShadowMatrix), r.lightProbeGrid = k.state.lightProbeGridArray.length > 0, r.currentProgram = d, r.uniformsList = null, d;
		}
		function wt(e) {
			if (e.uniformsList === null) {
				let t = e.currentProgram.getUniforms();
				e.uniformsList = Qc.seqWithValue(t.seq, e.uniforms);
			}
		...
		function Dt(e, t, n, r, i) {
			t.isScene !== !0 && (t = je), z.resetTextureUnits();
			let a = t.fog, o = r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial ? t.environment : null, s = P === null ? N.outputColorSpace : P.isXRRenderTarget === !0 ? P.texture.colorSpace : q.workingColorSpace, c = r.isMeshStandardMaterial || r.isMeshLambertMaterial && !r.envMap || r.isMeshPhongMaterial && !r.envMap, l = Le.get(r.envMap || o, c), u = r.vertexColors === !0 && !!n.attributes.color && n.attributes.color.itemSize === 4, d = !!n.attributes.tangent && (!!r.normalMap || r.anisotropy > 0), f = !!n.morphAttributes.position, p = !!n.morphAttributes.normal, m = !!n.morphAttributes.color, h = 0;
			r.toneMapped && (P === null || P.isXRRenderTarget === !0) && (h = N.toneMapping);
			...
			if (L.useProgram(x.program) && (S = !0, C = !0, w = !0), r.id !== ue && (ue = r.id, C = !0), v.needsLights) {
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Ye.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(F, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = yu()), C) {
				if (T.setValue(F, "toneMappingExposure", N.toneMappingExposure), v.needsLights && Ot(E, w), a && r.fog === !0 && He.refreshFogUniforms(E, a), He.refreshMaterialUniforms(E, r, ye, ve, k.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
				...
				Qc.upload(F, wt(v), E, z);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (Qc.upload(F, wt(v), E, z), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(F, "center", i.center), T.setValue(F, "modelViewMatrix", i.modelViewMatrix), T.setValue(F, "normalMatrix", i.normalMatrix), T.setValue(F, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
		...
		this.getActiveCubeFace = function() {
			...
			if (e) {
				...
				if (o.__useDefaultFramebuffer !== void 0) {
					L.bindFramebuffer(F.FRAMEBUFFER, o.__webglFramebuffer), fe.copy(e.viewport), pe.copy(e.scissor), me = e.scissorTest, L.viewport(fe), L.scissor(pe), L.setScissorTest(me), ue = -1;
					return;
				}
				...
				e.isWebGLCubeRenderTarget ? (r = Array.isArray(c[t]) ? c[t][n] : c[t], i = !0) : r = e.samples > 0 && z.useMultisampledRTT(e) === !1 ? R.get(e).__webglMultisampledFramebuffer : Array.isArray(c) ? c[n] : c, fe.copy(e.viewport), pe.copy(e.scissor), me = e.scissorTest;
			} else fe.copy(Se).multiplyScalar(ye).floor(), pe.copy(Ce).multiplyScalar(ye).floor(), me = we;
			if (n !== 0 && (r = ae), L.bindFramebuffer(F.FRAMEBUFFER, r) && L.drawBuffers(e, r), L.viewport(fe), L.scissor(pe), L.setScissorTest(me), i) {
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				...
				try {
					...
					t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i && F.readPixels(t, n, r, i, $e.convert(c), $e.convert(l), a);
				} finally {
					let e = P === null ? null : R.get(P).__webglFramebuffer;
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
					...
					F.bindBuffer(F.PIXEL_PACK_BUFFER, d), F.bufferData(F.PIXEL_PACK_BUFFER, a.byteLength, F.STREAM_READ), F.readPixels(t, n, r, i, $e.convert(l), $e.convert(u), 0);
					let f = P === null ? null : R.get(P).__webglFramebuffer;
					L.bindFramebuffer(F.FRAMEBUFFER, f);
					let p = F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE, 0);
					return F.flush(), await st(F, p, 4), F.bindBuffer(F.PIXEL_PACK_BUFFER, d), F.getBufferSubData(F.PIXEL_PACK_BUFFER, 0, a), F.deleteBuffer(d), F.deleteSync(p), a;
				}
			...
			if (e.isDepthTexture) {
				...
				L.bindFramebuffer(F.READ_FRAMEBUFFER, oe), L.bindFramebuffer(F.DRAW_FRAMEBUFFER, se);
			...
			ce = 0, le = 0, P = null, L.reset(), et.reset();
...
//#endregion
export { Ao as $, I as $t, Ze as A, O as At, Fa as B, D as Bt, yi as C, tn as Cn, Z as Ct, io as D, Pe as Dt, pn as E, fe as Et, Ci as F, de as Ft, $i as G, N as Gt, R as H, P as Ht, jo as I, le as It, f as J, Ea as Jt, Qi as K, M as Kt, ji as L, ce as Lt, b as M, ge as Mt, lo as N, be as Nt, xr as O, Ne as Ot, No as P, Ae as Pt, to as Q, pe as Qt, Pr as R, re as Rt, en as S, qa as Sn, ea as St, Xe as T, Ga as Tt, Ji as U, ue as Ut, Ie as V, Me as Vt, Bi as W, oe as Wt, u as X, j as Xt, d as Y, Kr as Yt, Ge as Z, r as Zt, la as _, v as _n, Do as _t, Ja as a, Si as an, K as at, Io as b, G as bn, Eo as bt, er as c, ga as cn, qr as ct, vo as d, t as dn, a as dt, F as en, $a as et, i as f, Zt as fn, o as ft, ca as g, w as gn, An as gt, q as h, T as hn, Ua as ht, bu as i, Ta as in, ts as it, jn as j, ne as jt, y as k, me as kt, vr as l, es as ln, Oa as lt, X as m, p as mn, s as mt, Q as n, We as nn, Rr as nt, Qo as o, _i as on, Y as ot, $o as p, so as pn, c as pt, l as q, te as qt, Is as r, zn as rn, Pt as rt, vi as s, Tr as sn, ai as st, Ds as t, he as tn, e as tt, Nr as u, wo as un, Da as ut, sa as v, g as vn, So as vt, ko as w, $t as wn, Ft as wt, nn as x, J as xn, aa as xt, ns as y, W as yn, Fi as yt, Ir as z, ae as zt };
