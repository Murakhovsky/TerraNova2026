...
final readonly class ReserveMatchedPropertyCommandHandler implements CommandHandlerInterface
{
    public function __construct(private RealEstateWorkflowService $workflow) {}
    public function __invoke(ReserveMatchedPropertyCommand $command):array
    {
        return $this->workflow->reserve(
