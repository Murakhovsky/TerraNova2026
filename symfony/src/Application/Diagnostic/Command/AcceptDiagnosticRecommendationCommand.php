...
{
    public function __construct(public OrganizationId $organizationId,public int $actorId,public string $sessionId,public string $recommendationId,public string $correlationId){}
}
