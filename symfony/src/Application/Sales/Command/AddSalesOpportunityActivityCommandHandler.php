...
final readonly class AddSalesOpportunityActivityCommandHandler implements CommandHandlerInterface
{
    ...
    public function __invoke(AddSalesOpportunityActivityCommand $command): SalesMutationResult
    {
        $result = $this->writes->forOrganization($command->organizationId->value())->addOpportunityActivity(
