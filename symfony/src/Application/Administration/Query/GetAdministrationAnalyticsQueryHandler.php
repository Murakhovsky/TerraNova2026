...
final readonly class GetAdministrationAnalyticsQueryHandler implements QueryHandlerInterface
{
    ...
    public function __invoke(GetAdministrationAnalyticsQuery $query): array
    {
