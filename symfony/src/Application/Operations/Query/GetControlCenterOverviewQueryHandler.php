...
final readonly class GetControlCenterOverviewQueryHandler implements QueryHandlerInterface
{
    ...
    public function __invoke(GetControlCenterOverviewQuery $query): array
    {
