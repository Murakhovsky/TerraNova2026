...
final class PatternRegistry
{
    ...
    public function all(): array
    {
        $patterns = [
            ...
            $this->pattern('ContextPanel', 'Present secondary context without competing with the primary task.', ['title', 'sections'], ['header', 'body', 'actions'], ['default', 'collapsed'], ['default'], ['normal', 'loading', 'empty'], ['desktop is side panel; tablet/mobile becomes drawer'], ['drawer focus is trapped and restored'], ['CosContextPanel', 'CosDrawer']),
