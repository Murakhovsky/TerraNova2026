...
final class LegacySessionAuthenticator extends AbstractAuthenticator implements AuthenticationEntryPointInterface
{
    ...
    public function supports(Request $request): ?bool
    {
        ...
        return str_starts_with($path, '/api/v1') || self::isProtectedWebPath($path);
    }
    ...
    {
        if (self::isProtectedWebPath($request->getPathInfo())) {
    ...
    private static function isProtectedWebPath(string $path): bool
    {
