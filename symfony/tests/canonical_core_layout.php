...
use App\Infrastructure\Persistence\MySql\MysqlIdentityRepository;
...
expectCanonical(
    ...
    'Canonical MySQL identity repository must implement the Kernel Identity resolver contract.',
);
expectCanonical(
