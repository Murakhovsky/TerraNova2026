...
$provider=new GrowthSignalPollingStatusProvider($targets,$modules,true,15,42,100);
...
$disabledProvider=new GrowthSignalPollingStatusProvider($targets,$modules,false,15,42,100);
...
$missingActor=new GrowthSignalPollingStatusProvider($targets,$modules,true,15,0,100);
