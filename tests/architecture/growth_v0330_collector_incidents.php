...
$assert(($manifest['version']??null)==='0.33.0','Growth V0.33 manifest version must be 0.33.0.');
$assert(($manifest['schema_version']??null)==='0.30.0','Growth V0.33 schema version must be 0.30.0.');
