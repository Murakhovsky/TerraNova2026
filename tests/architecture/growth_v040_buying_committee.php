...
$assert(($manifest['version']??null)==='0.4.0','Growth V0.4 manifest version must be 0.4.0.');
$assert(($manifest['schema_version']??null)==='0.4.0','Growth V0.4 schema version must be 0.4.0.');
