...
if (!str_contains($bootstrapSource, 'Kernel\\Visualization\\Graph\\GraphProviderInterface:')) {
    throw new RuntimeException('Architecture graph provider is not registered in Symfony services.');
}
