...
$mustContain('app/Domains/Sales/Infrastructure/Persistence/MySql/MysqlDealRepository.php', ['lost_reason_id','lost_reason_note','Stage history is event-owned from V0.8.1 onward'], 'deal persistence');
