...
$assert(
    ...
    'Symfony Visualization composition must register the projection registry contract.',
);
$assert(
    ...
    'Projection registry must resolve through the canonical Symfony factory.',
);
