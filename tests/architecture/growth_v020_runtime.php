...
$assert(($manifest['version']??null)==='0.2.0','Growth V0.2 manifest version must be 0.2.0.');
$assert(($manifest['schema_version']??null)==='0.2.0','Growth V0.2 schema version must be 0.2.0.');
