...
if (!str_contains($diagnosticController, "['diagnostics-methodology-studio']")) throw new RuntimeException('Symfony Methodology Studio must load through a Vite feature entrypoint.');
if (!str_contains($diagnosticController, 'DiagnosticMethodologyAccess::VIEW')) throw new RuntimeException('Symfony Methodology Studio must preserve fine-grained Diagnostic access.');
