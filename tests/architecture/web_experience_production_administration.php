...
foreach ([
    ...
    'name="provider"',
    'name="external_url"',
    'name="default_camera_json"',
    'name="settings_json"',
] as $marker) {
    $contains($spatialEdit, $marker, 'Spatial editor lost a canonical or interaction/mutation contract.');
}
foreach ([
    'tn-page-hero tn-page-hero--catalog',
    'tn-admin-card',
...
foreach ([
    ...
    $contains($spatialScene, $marker, 'Public Spatial viewer must remain a specialized public surface.');
}
...
foreach ([
    ...
    $contains($spatialEdit, $marker, 'Spatial editor lost a canonical or upload/capture/hotspot contract.');
}
foreach ([
    'tn-page-hero tn-page-hero--catalog',
    'tn-admin-card',
...
foreach ([
    ...
    $contains($spatialScene, $marker, 'Public Spatial scene must remain a specialized viewer surface.');
}
