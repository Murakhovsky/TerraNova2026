...
$assert(($manifest['version']??null)==='0.31.0','Growth V0.31 manifest version must be 0.31.0.');
$assert(($manifest['schema_version']??null)==='0.28.0','Growth V0.31 must keep schema version 0.28.0.');
