...
foreach(['PDO','Domains\\Sales\\','use Kernel\\Action\\ActionProposal;','new ActionProposal(','use Kernel\\Policy\\Service\\ActionPolicyService;','use Kernel\\Action\\Service\\ActionService;','ExecuteSalesActionCommand'] as $forbidden){
