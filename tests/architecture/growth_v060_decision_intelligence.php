...
$assert(version_compare((string)($manifest['version']??'0.0.0'),'0.6.0','>='),'Growth manifest must remain V0.6+.');
$assert(version_compare((string)($manifest['schema_version']??'0.0.0'),'0.6.0','>='),'Growth schema must remain V0.6+.');
