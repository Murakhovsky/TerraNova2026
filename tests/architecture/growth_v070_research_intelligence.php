...
$assert(($manifest['version']??null)==='0.7.0','Growth V0.7 manifest version must be 0.7.0.');
$assert(($manifest['schema_version']??null)==='0.7.0','Growth V0.7 schema version must be 0.7.0.');
