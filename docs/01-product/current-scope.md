...
| Growth | `0.9.0` | Opportunity Intelligence + resumable Handoff Protocol + first concrete Sales target adapter; schema remains `0.8.0`; disabled by default |
