...
| Growth | `0.25.0` | Opportunity Intelligence + Experiments + governed Engagement Execution + Sales/Service handoff targets; schema `0.22.0`; disabled by default |
