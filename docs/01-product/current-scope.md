...
| Growth | `0.13.0` | Opportunity Intelligence + API/Workspace + Signal Operations + signed external Signal webhook; schema remains `0.8.0`; disabled by default |
