...
| Growth | `0.27.0` | Opportunity Intelligence + Sales/Service handoff + governed Engagement + RSS/Atom collector/workspace; schema `0.26.0`; disabled by default |
