...
| Growth | `0.17.0` | Opportunity Intelligence + Engagement + closed-loop learning + governed Learning Optimization; schema `0.17.0`; disabled by default |
