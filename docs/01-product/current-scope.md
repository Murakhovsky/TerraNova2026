...
| Growth | `0.8.0` | Opportunity + Account/Committee + Signal/Research/Decision Intelligence + resumable cross-domain Handoff Protocol; disabled by default |
