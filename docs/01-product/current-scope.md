...
| Growth | `0.32.0` | Opportunity Intelligence + automatic Signal monitoring + collector health/adaptive backoff; schema `0.29.0`; disabled by default |
...
Growth `0.32.0` розвиває окремий bounded context для **FIND VALUE**. Canonical runtime визначає `Signal`, `OpportunityCandidate`, `OpportunityRationale`, explainable Fit/Need/Timing/Access/Value scoring, lifecycle qualification та `OpportunityHandoff`.
