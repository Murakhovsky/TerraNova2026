...
| Growth | `0.16.0` | Opportunity Intelligence + Signal Intake + Engagement Intelligence + closed-loop learning + Learning Workspace; schema `0.15.0`; disabled by default |
