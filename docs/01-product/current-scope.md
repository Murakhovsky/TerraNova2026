...
| Growth | `0.12.0` | Opportunity Intelligence + API V1 + SSR Workspace + Signal Operations for evidence stream and collector runs; schema remains `0.8.0`; disabled by default |
