...
| Growth | `0.23.0` | Opportunity Intelligence + Experiments + governed post-handoff Engagement Execution Bridge; schema `0.22.0`; disabled by default |
