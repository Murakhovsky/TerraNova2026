...
| Growth | `0.18.0` | Opportunity Intelligence + closed-loop Learning Optimization + executable Optimization Workspace; schema remains `0.17.0`; disabled by default |
