...
| Growth | `0.34.0` | Opportunity Intelligence + automatic Signal monitoring + incidents + explicit tenant email alert subscriptions; schema `0.31.0`; disabled by default |
