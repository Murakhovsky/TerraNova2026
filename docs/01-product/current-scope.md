...
| Growth | `0.30.0` | Opportunity Intelligence + governed Engagement + RSS/Atom/credentialed JSON Signal monitoring with async scheduled polling; schema `0.28.0`; disabled by default |
