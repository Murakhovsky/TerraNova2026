...
| Growth | `0.24.0` | Opportunity Intelligence + Experiments + governed post-/pre-handoff Engagement Execution; schema `0.22.0`; disabled by default |
