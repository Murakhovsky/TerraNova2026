...
| Growth | `0.33.0` | Opportunity Intelligence + automatic Signal monitoring + adaptive backoff + collector incident lifecycle; schema `0.30.0`; disabled by default |
