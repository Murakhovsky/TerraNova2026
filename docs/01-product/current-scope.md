...
| Growth | `0.29.0` | Opportunity Intelligence + Sales/Service handoff + governed Engagement + RSS/Atom + credentialed JSON collector workspace; schema `0.28.0`; disabled by default |
