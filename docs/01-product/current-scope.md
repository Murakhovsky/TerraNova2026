...
| Growth | `0.28.0` | Opportunity Intelligence + Sales/Service handoff + governed Engagement + RSS/Atom + credentialed JSON collectors; schema `0.28.0`; disabled by default |
