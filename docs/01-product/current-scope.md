...
| Growth | `0.19.0` | Opportunity Intelligence + Learning Optimization + controlled Experiments & Attribution runtime; schema `0.19.0`; disabled by default |
