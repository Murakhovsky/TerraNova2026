...
main executable metadata / code
        +
main structured platform contracts
        ↓
COS generators
        ↓
generated Markdown
...
| --- | --- | --- |
| Canonical business processes, ownership, topology, capability coverage і runtime verification | [Business Process Registry](business-processes.md) | `resources/processes/*.json` + `Kernel\\Process` + current-checkout runtime evidence |
