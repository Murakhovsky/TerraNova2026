...
| `growth` | `app/migrations/20260924_000100_growth_v0350_linkedin_call_execution.sql` | — |
| `growth` | `app/migrations/20260924_000101_growth_v0360_engagement_delivery_feedback.sql` | `tn_growth_engagement_delivery_observations` |
| `growth` | `app/migrations/20260924_000102_growth_v0370_outreach_guardrails.sql` | — |
| `growth` | `app/migrations/20260924_000103_growth_v0380_tenant_outreach_limits.sql` | `tn_growth_engagement_limit_profiles` |
| `growth` | `app/migrations/20260924_000104_growth_v0390_channel_outreach_quotas.sql` | `tn_growth_engagement_limit_profiles` |
| `growth` | `app/migrations/20260924_000105_growth_v0400_atomic_outreach_capacity.sql` | `tn_growth_engagement_capacity_locks` |
| `growth` | `app/migrations/20260924_000106_growth_v0410_outreach_activation_policy.sql` | `tn_growth_engagement_activation_profiles` |
| `growth` | `app/migrations/20260925_000107_growth_v0420_autonomous_outreach.sql` | `tn_growth_engagement_autonomy_payloads` |
| `growth` | `app/migrations/20260925_000107_growth_v0420_autonomous_outreach.sql` | `tn_growth_engagement_autonomy_profiles` |
| `growth` | `app/migrations/20260926_000108_growth_v0430_autonomous_content_review.sql` | `tn_growth_engagement_content_drafts` |
| `growth` | `app/migrations/20260926_000108_growth_v0430_autonomous_content_review.sql` | `tn_growth_engagement_content_review_profiles` |
| `growth` | `app/migrations/20260926_000108_growth_v0430_autonomous_content_review.sql` | `tn_growth_engagement_content_runs` |
| `growth` | `app/migrations/20260926_000109_growth_v0440_outreach_sequences.sql` | `tn_growth_engagement_sequence_profiles` |
| `growth` | `app/migrations/20260926_000109_growth_v0440_outreach_sequences.sql` | `tn_growth_engagement_sequence_steps` |
| `growth` | `app/migrations/20260926_000109_growth_v0440_outreach_sequences.sql` | `tn_growth_engagement_sequences` |
| `growth` | `app/migrations/20260926_000110_growth_v0450_inbound_responses.sql` | `tn_growth_engagement_response_classifications` |
| `growth` | `app/migrations/20260926_000110_growth_v0450_inbound_responses.sql` | `tn_growth_engagement_responses` |
| `growth` | `app/migrations/20260926_000111_growth_v0460_conversation_routing.sql` | `tn_growth_conversation_routes` |
| `growth` | `app/migrations/20260926_000111_growth_v0460_conversation_routing.sql` | `tn_growth_engagement_suppressions` |
| `growth` | `app/migrations/20260926_000112_growth_v0470_email_delivery_parity.sql` | — |
| `growth` | `app/migrations/20260926_000113_growth_v0480_market_discovery.sql` | `tn_growth_market_discovery_runs` |
| `growth` | `app/migrations/20260926_000113_growth_v0480_market_discovery.sql` | `tn_growth_market_memberships` |
| `growth` | `app/migrations/20260926_000113_growth_v0480_market_discovery.sql` | `tn_growth_market_universes` |
| `growth` | `app/migrations/20260926_000114_growth_v0490_cos_for_cos_vertical_slice.sql` | — |
| `growth` | `app/migrations/20260926_000115_growth_v0500_release_hardening.sql` | `tn_growth_market_discovery_runs` |
