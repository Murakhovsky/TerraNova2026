...
function render(definitions) {
  const lines = [
    ...
    '',
    'Generated from canonical `resources/processes/*.json`, module capabilities and the current-checkout runtime evidence catalogue. Do not edit this page manually.',
    '',
